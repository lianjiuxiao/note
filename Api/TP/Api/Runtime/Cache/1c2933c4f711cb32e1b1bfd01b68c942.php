...
<div id="page-wrapper">
	...
	<div id="site-header" class="push-up" role="banner" style="padding-top:15px;padding-bottom:20px;">
		...
		<main id="main-content" role="main">
			...
			<div class="row" style="background: url(__PUBLIC__/index/rev-slider/img/slides/login.jpg) no-repeat;background-size:70% auto;height:430px;border-top:5px solid white;border-bottom:5px solid white;">
				<div class="col-md-offset-8 col-md-4 col-xs-offset-2 col-xs-8">
					<form class="form-horizontal" role="form" action="__URL__/loginVerify" method="post">
					  	...
					  	<div class="form-group" id="dvcode" style="padding-bottom:10px;">
							<label for="vcode" class="col-xs-4 control-label" style="color:#666666">验证码</label>
							<div class="col-xs-4">
						 		<input type="text" class="form-control primary" id="vcode" placeholder="验证码">
							</div>
							<div class="col-xs-4">
								<img src="__URL__/verify/" onclick="this.src='__URL__/verify/'+Math.round(new Date().getTime()/1000)" title="看不清楚直接点击验证码更换" alt="验证码" style="width:68%;height:32px;vertical-align:middle;">
							</div>
					  	</div>
					  	<div class="form-group">
							<div class="col-xs-offset-4 col-xs-3" id="errorVcode">
							</div>
					  	</div>
					  	<div class="form-group">
			...
			<div class="footer-sub">
				<div class="container">
					...
					<div class="text-center">
						<div class="copyright center-xs" style="padding-top:10px;padding-bottom:10px;">
	...
	$(function(){
		$("#vcode").blur(function(){ 
			...
			else
			{
				...
				$.ajax({
			   		type: "get",
			   		url: "__URL__/ajaxLogin?vcode="+$("#vcode").val(),
			   		success: function(msg){
			     		if(msg == 'VcodeFalse')
			     		{
							$("#dvcode").addClass("has-error");
							$("#vcode").val("");
							$("#vcode").attr("placeholder","验证码输入错误");
			     		}
			     		if(msg == 'VcodeTrue')
			     		{
			     			$("#dvcode").removeClass("has-error");
			     		}
			   		}
				});
			}
