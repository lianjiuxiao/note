		...
		<div class="flexslider">
			<ul class="slides">
				...
				<li style="background: #fa6f57;">
					...
					data-y="60"
					data-speed="600"
					data-start="1200"><div class="vmid"><span>冬末<br/>清仓</span></div></div>
					...
					data-y="270"
					data-speed="400"
					data-start="1800"><strong class="text-bold"></strong>最多可享100元优惠</div>
				</li>
