...
<div id="content">
	<!-- 顶部右侧快捷操作按钮 开始 -->
		...
		<div id="breadcrumb">
			...
			<a href="__URL__/lists" title="返回邮件管理" class="tip-bottom"> 邮件管理</a>
			<a href="#" class="current"> 邮件模板列表</a>
		</div>
		<!-- 顶部面包屑导航 结束 -->
		<!-- 主体区域 -->
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="widget-box">
						<!-- 组件标题区域 -->
						<div class="widget-title"><h5>邮件模板列表</h5></div>
						<!-- 组件内容区域 -->
							...
							<table class="table table-bordered data-table">
								...
								<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
										...
										<td class="taskOptions">
									    	<a href="__URL__/send/id/<?php echo ($v["id"]); ?>" class="tip-top" data-original-title="发送"><i class="icon-share-alt"></i></a>&nbsp;&nbsp;<a href="__URL__/upda/id/<?php echo ($v["id"]); ?>" class="tip-top" data-original-title="编辑"><i class="icon-pencil"></i></a>&nbsp;&nbsp;<a href="__URL__/del/id/<?php echo ($v["id"]); ?>" class="tip-top" data-original-title="删除"><i class="icon-remove"></i></a>
										</td>
