...
<div id="content">
	<!-- 顶部右侧快捷操作按钮 开始 -->
		...
		<div id="breadcrumb">
			...
			<a href="__URL__/lists" title="返回管理员列表" class="tip-bottom"> 管理员列表</a>
			<a href="#" class="current"> 编辑管理员资料</a>
		</div>
		<!-- 顶部面包屑导航 结束 -->
		<!-- 主体区域 -->
						...
						<div class="widget-content nopadding">
							...
							<form action="__URL__/edit" method="post" class="form-horizontal">
								...
								<div class="control-group">
									...
									<div class="controls"><input type="text" value="<?php echo ($u["username"]); ?>" readonly /></div>
								</div>
								<div class="control-group">
								...
								<div class="control-group">
									...
									<div class="controls"><input type="text" name="email" value="<?php echo ($u["email"]); ?>"/></div>
								</div>
								<div class="control-group">
									<label class="control-label">用户权限：</label>
									<div class="controls">
										<?php if(is_array($data)): foreach($data as $key=>$v): ?><input type="checkbox" name="status[]" <?php echo ($v["checked"]); ?> value="<?php echo ($v["status"]); ?>"><?php echo ($v["description"]); ?><br /><?php endforeach; endif; ?>
									</div>
								</div>
								<!-- 提交提交按钮 -->
