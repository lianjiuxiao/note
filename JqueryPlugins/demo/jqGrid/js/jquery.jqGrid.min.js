...
(function(b) {
    ...
    b.extend(b.jgrid, {
        ...
        stringToDoc: function(d) {
            ...
            try { i = (new DOMParser).parseFromString(d, "text/xml") } catch (g) { i = new ActiveXObject("Microsoft.XMLDOM");
                i.async = false;
                i.loadXML(d) }
        ...
        parse: function(d) {
            ...
            d || (d = "{}");
            return b.jgrid.useJSON ===
                true && typeof JSON === "object" && typeof JSON.parse === "function" ? JSON.parse(d) : eval("(" + d + ")")
        },
        parseDate: function(d, i) {
            var g = { m: 1, d: 1, y: 1970, h: 0, i: 0, s: 0, u: 0 },
                c, h, k;
            c = /[\\\/:_;.,\t\T\s-]/;
            if (i && i !== null && i !== undefined) {
                ...
                var l = b.jgrid.formatter.date.monthNames,
                    ...
                    q = function(x, y) {
                        if (x === 0) {
                            if (y === 12) y = 0 } else if (y !== 12) y += 12;
                        return y };
                c = 0;
                for (h = d.length; c < h; c++) {
                    if (d[c] == "M") { k = b.inArray(i[c], l);
                        if (k !== -1 && k < 12) i[c] = k + 1 }
                    if (d[c] == "F") {
                        k = b.inArray(i[c],
                            l);
                    ...
                    if (d[c] == "a") { k = b.inArray(i[c], a);
                        if (k !== -1 && k < 2 && i[c] == a[k]) { i[c] = k;
                            g.h = q(i[c], g.h) } }
                    if (d[c] == "A") { k = b.inArray(i[c], a);
                        if (k !== -1 && k > 1 && i[c] == a[k]) { i[c] = k - 2;
                            g.h = q(i[c], g.h) } }
        ...
        from: function(d) {
            return new function(i, g) {
                ...
                if (typeof i == "object" && i.push) {
                    if (i.length > 0) V = typeof i[0] != "object" ? false : true } else throw "data provides is not an array";
                ...
                this._group = function(o, n) {
                    return { field: o.toString(), unique: n, items: [] } };
                ...
                this._funcLoop = function(o) {
                    var n = [];
                    b.each(h, function(t, F) { n.push(o(F)) });
                    return n };
                ...
                this._setCommand = function(o, n) { x = o;
                    y = n };
                this._resetNegate = function() { I = false };
                ...
                this._compare = function(o, n, t) {
                    ...
                    if (o !== null && n === null) return -1;
                    if (!k && typeof o !== "number" && typeof n !== "number") { o = String(o).toLowerCase();
                ...
                this._doSort = function(o, n) {
                    ...
                    F = [];
                    for (T = 0; T < t.length; T++) { J = c._doSort(t[T].items, n);
                ...
                this._getOrder = function(o, n, t, F, T) {
                    ...
                    fa = F == "float" || F == "number" || F == "currency" || F == "numeric" ? function(R) { R = parseFloat(String(R).replace(q, ""));
                        return isNaN(R) ? 0 : R } : F == "int" || F == "integer" ? function(R) {
                        return R ? parseFloat(String(R).replace(q, "")) : 0 } : F == "date" || F == "datetime" ? function(R) {
                        return b.jgrid.parseDate(T, R).getTime() } : b.isFunction(F) ? F : function(R) { R || (R = "");
                    ...
                    b.each(o, function(R, aa) {
                        ...
                        if (X === undefined) X =
                            "";
                        X = fa(X, aa);
                        D.push({ vSort: X, index: R })
                    });
                    D.sort(function(R, aa) { R = R.vSort;
                        aa = aa.vSort;
                        return c._compare(R, aa, ca) });
                    F = 0;
                    for (var pa = o.length; F < pa;) { t = D[F].index;
                        J.push(o[t]);
                        F++ }
                    return J
                };
                this._getGroup = function(o, n, t, F, T) {
                    var J = [],
                        ...
                        ca = null,
                        X;
                    b.each(c._getOrder(o, n, t, F, T), function(fa, pa) { X = b.jgrid.getAccessor(pa, n);
                        if (X === undefined) X = "";
                        if (!c._equals(ca, X)) { ca = X;
                            D !== null && J.push(D);
                            D = c._group(n, X) }
                        D.items.push(pa) });
                    D !== null && J.push(D);
                ...
                this.execute = function() {
                    var o = a,
                        n = [];
                    if (o === null) return c;
                    b.each(h, function() { eval(o) && n.push(this) });
                    h = n;
                    return c };
                this.data = function() {
                    return h };
                this.select = function(o) { c._performSort();
                ...
                this.andNot = function(o, n, t) { I = !I;
                    return c.and(o, n, t) };
                this.orNot = function(o, n, t) { I = !I;
                    return c.or(o, n, t) };
                this.not = function(o, n, t) {
                    return c.andNot(o, n, t) };
                this.and = function(o, n, t) { M = " && ";
                    if (o === undefined) return c;
                    return c._repeatCommand(o, n, t) };
                this.or = function(o, n, t) { M = " || ";
                    if (o === undefined) return c;
                    return c._repeatCommand(o, n, t) };
                this.orBegin = function() { E++;
                    return c };
                this.orEnd = function() {
                    if (a !== null) a += ")";
                    return c };
                this.isNot = function(o) { I = !I;
                    return c.is(o) };
                this.is = function(o) {
                    c._append("this." +
                        o);
                ...
                this.startsWith = function(o, n) {
                    ...
                    if (V) c._append(c._getStr("jQuery.jgrid.getAccessor(this,'" + o + "')") + ".substr(0," + t + ") == " +
                        c._getStr('"' + c._toStr(n) + '"'));
                    else { t = l ? b.trim(n.toString()).length : n.toString().length;
                ...
                this.endsWith = function(o, n) {
                    var t = n === undefined || n === null ? o : n;
                    t = l ? b.trim(t.toString()).length : t.toString().length;
                    V ? c._append(c._getStr("jQuery.jgrid.getAccessor(this,'" + o + "')") + ".substr(" + c._getStr("jQuery.jgrid.getAccessor(this,'" + o + "')") + ".length-" + t + "," + t + ') == "' + c._toStr(n) +
                        '"') : c._append(c._getStr("this") + ".substr(" + c._getStr("this") + '.length-"' + c._toStr(o) + '".length,"' + c._toStr(o) + '".length) == "' + c._toStr(o) + '"');
                    c._setCommand(c.endsWith, o);
                    c._resetNegate();
                    return c
                };
                this.contains = function(o, n) { V ? c._append(c._getStr("jQuery.jgrid.getAccessor(this,'" + o + "')") + '.indexOf("' + c._toStr(n) + '",0) > -1') : c._append(c._getStr("this") + '.indexOf("' + c._toStr(o) + '",0) > -1');
                ...
                this.orderBy = function(o, n, t, F) { n = n === undefined || n === null ? "a" : b.trim(n.toString().toLowerCase());
                    if (t === null || t === undefined) t = "text";
                    if (F === null || F === undefined) F = "Y-m-d";
                    if (n == "desc" || n == "descending") n = "d";
                    if (n == "asc" || n == "ascending") n = "a";
                    N.push({ by: o, dir: n, type: t, datefmt: F });
                    return c };
                return c
            }(d, null)
        },
        extend: function(d) { b.extend(b.fn.jqGrid, d);
            this.no_legacy_api || b.fn.extend(d) }
    });
    b.fn.jqGrid = function(d) {
        if (typeof d == "string") {
            var i = b.jgrid.getAccessor(b.fn.jqGrid,
                d);
            ...
            if (!this.grid) {
                var c = b.extend(true, {
                    ...
                    h = {
                        ...
                        dragStart: function(e, f, j) {
                            this.resizing = { idx: e, startX: f.clientX, sOL: j[0] };
                            this.hDiv.style.cursor = "col-resize";
                            this.curGbox = b("#rs_m" + b.jgrid.jqID(c.id), "#gbox_" + b.jgrid.jqID(c.id));
                            this.curGbox.css({ display: "block", left: j[0], top: j[1], height: j[2] });
                            b.isFunction(c.resizeStart) && c.resizeStart.call(this,
                                f, e);
                        ...
                        dragMove: function(e) {
                            if (this.resizing) {
                                ...
                                var j = c.direction === "ltr" ? e.width + f : e.width - f,
                                    m;
                                if (j > 33) { this.curGbox.css({ left: this.resizing.sOL + f });
                                    if (c.forceFit === true) { m = this.headers[this.resizing.idx + c.nv];
                                        f = c.direction === "ltr" ? m.width - f : m.width + f;
                                        if (f > 33) { e.newWidth = j;
                                            m.newWidth = f } } else { this.newWidth = c.direction === "ltr" ? c.tblwidth + f : c.tblwidth - f;
                                        e.newWidth = j } } } },
                        dragEnd: function() {
                            ...
                            if (this.resizing) {
                                ...
                                if (c.forceFit === true) {
                                    ...
                                    this.headers[e + c.nv].el.style.width =
                                        f + "px";
                        ...
                        populateVisible: function() {
                            ...
                            if (e) {
                                var f = b("table:first", h.bDiv),
                                    j, m;
                                if (f[0].rows.length) try { m = (j = f[0].rows[1]) ? b(j).outerHeight() || h.prevRowHeight : h.prevRowHeight } catch (p) { m = h.prevRowHeight }
                                if (m) {
                                    h.prevRowHeight = m;
                                    var C = c.rowNum;
                                    ...
                                    m *= C;
                                    var z, u, w;
                                    if (A < e && s <= 0 && (c.lastpage === undefined || parseInt((A + j +
                                            m - 1) / m, 10) <= c.lastpage)) { u = parseInt((e - A + m - 1) / m, 10);
                                        if (A >= 0 || u < 2 || c.scroll === true) { z = Math.round((A + j) / m) + 1;
                                            s = -1 } else s = 1 }
                                    if (s > 0) { z = parseInt(j / m, 10) + 1;
                                        u = parseInt((j + e) / m, 10) + 2 - z;
                                        w = true }
                                    if (u)
                                        if (!(c.lastpage && z > c.lastpage || c.lastpage == 1 || z === c.page && z === c.lastpage))
                                            if (h.hDiv.loading) h.timer = setTimeout(h.populateVisible, c.scrollTimeout);
                                            else { c.page = z;
                                                if (w) { h.selectionPreserver(f[0]);
                            ...
                            f.gridComplete = function() {
                                ...
                                if (f.multiselect && m && m.length > 0)
                                    for (var s = 0; s < m.length; s++) m[s] !=
                                        j && b(e).jqGrid("setSelection", m[s], false);
                ...
                if (this.tagName.toUpperCase() != "TABLE") alert("Element is not a table");
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                        ...
                        b(I).insertBefore(q).attr({ id: "gbox_" + this.id, dir: l });
                        b(q).appendTo(I).attr("id", "gview_" +
                            this.id);
                        ...
                        var M = function(e, f) { e = parseInt(e, 10);
                            ...
                            function(e, f, j, m, p) {
                                ...
                                if (typeof C.formatter !== "undefined") { e = { rowId: e, colModel: C, gid: a.p.id, pos: j };
                                    f = b.isFunction(C.formatter) ? C.formatter.call(a, f, e, m, p) : b.fmatter ? b.fn.fmatter(C.formatter, f, e, m, p) : V(f) } else f = V(f);
                                return f },
                            n = function(e, f, j, m, p) { f = o(e, f, j, p, "add");
                            ...
                            t = function(e, f, j) {
                                ...
                                return '<td role="gridcell" ' +
                                    N(f, j, "", null, e, true) + ">" + m + "</td>"
                            },
                            F = function(e, f, j, m) { j = (parseInt(j, 10) - 1) * parseInt(m, 10) + 1 + f;
                                return '<td role="gridcell" class="ui-state-default jqgrid-rownum" ' + N(e, f, j, null, f, true) + ">" + j + "</td>" },
                            T = function(e) {
                                var f, j = [],
                                    m = 0,
                                    p;
                                for (p = 0; p < a.p.colModel.length; p++) { f = a.p.colModel[p];
                                    if (f.name !== "cb" && f.name !== "subgrid" && f.name !== "rn") { j[m] = e == "local" ? f.name : e == "xml" || e === "xmlstring" ? f.xmlmap || f.name : f.jsonmap || f.name;
                                        m++ } }
                                return j },
                            J = function(e) {
                            ...
                            D = function(e, f, j) {
                                ...
                                if (f && a.p.scroll) { b(">div:first", e).css({ height: "auto" }).children("div:first").css({ height: 0, display: "none" });
                                    e.scrollTop = 0 }
                                if (j === true)
                                    if (a.p.treeGrid === true) { a.p.data = [];
                                        a.p._index = {} } },
                            ca = function() {
                                var e =
                                    a.p.data.length,
                                ...
                                for (j = 0; j < e; j++) { m = b.jgrid.getAccessor(a.p.data[j], f);
                                    a.p._index[m] = j }
                            },
                            X = function(e, f, j, m, p) {
                                ...
                                a.p.reccount =
                                    0;
                                if (b.isXMLDoc(e)) {
                                    if (a.p.treeANode === -1 && !a.p.scroll) { D(f, false, true);
                                        j = 1 } else j = j > 1 ? j : 1;
                                    var u, w, r = 0,
                                        G, O = 0,
                                        S = 0,
                                    ...
                                    if (Z.length > 0 && !isNaN(L)) {
                                        ...
                                        L = Z[L] }
                                    z = (L + "").indexOf("[") === -1 ? Z.length ? function(ga, ba) {
                                        return b(L, ga).text() || ba } : function(ga, ba) {
                                        return b(A.cell, ga).eq(L).text() || ba } : function(ga,
                                        ba) {
                                    ...
                                    else b.jgrid.getXmlData(e, A.userdata, true).each(function() { a.p.userData[this.getAttribute("name")] = b(this).text() });
                                    ...
                                    if (e && $) {
                                        ...
                                        for (; W < $;) {
                                            ...
                                            if (a.p.rownumbers === true) {
                                                U.push(F(0,
                                                    W, a.p.page, a.p.rowNum));
                                                K = 1
                                            }
                                            if (a.p.multiselect === true) { U.push(t(H, K, W));
                                                O = 1 }
                                            if (a.p.subGrid === true) { U.push(b(a).jqGrid("addSubGridCell", O + K, W + j));
                                                S = 1 }
                                            if (A.repeatitems) { P || (P = J(O + S + K));
                                                var Ca = b.jgrid.getXmlData(B, A.cell, true);
                                                b.each(P, function(ga) {
                                                    var ba = Ca[this];
                                                    if (!ba) return false;
                                                    G = ba.textContent || ba.text;
                                                    v[a.p.colModel[ga + O + S + K].name] = G;
                                                    U.push(n(H, G, ga + O + S + K, W + j, B)) }) } else
                                                for (u = 0; u < Z.length; u++) { G = b.jgrid.getXmlData(B, Z[u]);
                                                    v[a.p.colModel[u + O + S + K].name] = G;
                                                    U.push(n(H, G, u + O + S + K, W + j, B)) }
                                            U.push("</tr>");
                                            if (a.p.grouping) { u = a.p.groupingView.groupField.length;
                                                for (var Da = [], za = 0; za < u; za++) Da.push(v[a.p.groupingView.groupField[za]]);
                                                ha = b(a).jqGrid("groupingPrepare", U, Da, ha, v);
                                                U = [] }
                                            if (s || a.p.treeGrid === true) { v._id_ = H;
                                                a.p.data.push(v);
                                                a.p._index[H] = a.p.data.length - 1 }
                                            if (a.p.gridview === false) { b("tbody:first", f).append(U.join(""));
                                    ...
                                    if (a.p.subGrid === true) try { b(a).jqGrid("addSubGrid", O + K) } catch (Ka) {}
                                    a.p.totaltime = new Date - C;
                                    if (r > 0)
                                        if (a.p.records === 0) a.p.records = $;
                                    U = null;
                                    if (a.p.treeGrid === true) try { b(a).jqGrid("setTreeNode", w + 1, r + w + 1) } catch (La) {}
                                        ...
                                        for (; r < $;) { B = e[r];
                                            ...
                                            if (A.repeatitems) { P || (P = J(O + S + K));
                                                ...
                                                b.each(P, function(ga) {
                                                    ...
                                                    if (!ba) return false;
                                                    G = ba.textContent || ba.text;
                                                    v[a.p.colModel[ga + O + S + K].name] = G }) } else
                                                for (u = 0; u < Z.length; u++) { G = b.jgrid.getXmlData(B, Z[u]);
                                                    v[a.p.colModel[u + O + S + K].name] = G }
                                            v._id_ = H;
                                            a.p.data.push(v);
                            ...
                            fa = function(e, f, j, m, p) {
                                ...
                                if (e) {
                                    ...
                                    if (A) { a.p.data = [];
                                        ...
                                        a.p.localReader.id = "_id_" }
                                    a.p.reccount = 0;
                                    if (a.p.datatype == "local") { f = a.p.localReader;
                                        s = "local" } else { f = a.p.jsonReader;
                                        s = "json" }
                                    var z = 0,
                                        u, w, r = [],
                                        G, O = 0,
                                    ...
                                    if (r.length > 0 && !isNaN(s)) {
                                        ...
                                        s = r[s] }(Z = b.jgrid.getAccessor(e, f.root)) || (Z = []);
                                    L = Z.length;
                                    e = 0;
                                    ...
                                    var W = b.isFunction(a.p.afterInsertRow),
                                        ...
                                        ja = "";
                                    if (a.p.grouping &&
                                        a.p.groupingView.groupCollapse === true) ja = ' style="display:none;"';
                                    for (; e < L;) {
                                        p = Z[e];
                                        B = b.jgrid.getAccessor(p, s);
                                        if (B === undefined) { B = $ + e;
                                            if (r.length === 0)
                                                if (f.cell) { u = b.jgrid.getAccessor(p, f.cell);
                                                    B = u !== undefined ? u[s] || B : B } }
                                        B = a.p.idPrefix + B;
                                        u = j === 1 ? 0 : j;
                                        u = (u + e) % 2 == 1 ? U : "";
                                        H.push("<tr" + ja + ' id="' + B + '" tabindex="-1" role="row" class= "ui-widget-content jqgrow ui-row-' + a.p.direction + "" + u + '">');
                                        if (a.p.rownumbers === true) { H.push(F(0, e, a.p.page, a.p.rowNum));
                                            K = 1 }
                                        if (a.p.multiselect) { H.push(t(B, K, e));
                                            O = 1 }
                                        if (a.p.subGrid) {
                                            H.push(b(a).jqGrid("addSubGridCell",
                                                O + K, e + j));
                                            S = 1
                                        }
                                        if (f.repeatitems) {
                                            ...
                                            G || (G = J(O + S + K)) }
                                        for (w = 0; w < G.length; w++) { u = b.jgrid.getAccessor(p, G[w]);
                                        ...
                                        if (a.p.grouping) { u = a.p.groupingView.groupField.length;
                                            ...
                                            H = [] }
                                        if (A || a.p.treeGrid === true) { P._id_ = B;
                                            a.p.data.push(P);
                                            a.p._index[B] = a.p.data.length - 1 }
                                        if (a.p.gridview === false) {
                                            b("#" +
                                                b.jgrid.jqID(a.p.id) + " tbody:first").append(H.join(""));
                                    ...
                                    if (a.p.gridview === true) { v = a.p.treeANode > -1 ? a.p.treeANode : 0;
                                    ...
                                    if (a.p.subGrid === true) try { b(a).jqGrid("addSubGrid", O + K) } catch (ya) {}
                                    a.p.totaltime = new Date - C;
                                    if (z > 0)
                                        if (a.p.records === 0) a.p.records =
                                            L;
                                    if (a.p.treeGrid === true) try { b(a).jqGrid("setTreeNode", v + 1, z + v + 1) } catch (Ca) {}
                                    if (!a.p.treeGrid && !a.p.scroll) a.grid.bDiv.scrollTop = 0;
                                    a.p.reccount = z;
                                    a.p.treeANode = -1;
                                    a.p.userDataOnFooter && b(a).jqGrid("footerData", "set", a.p.userData, true);
                                    ...
                                    if (A)
                                        for (; z < L && Z[z];) {
                                            ...
                                            if (B === undefined) { B = $ + z;
                                                if (r.length === 0)
                                                    if (f.cell) B = b.jgrid.getAccessor(p, f.cell)[s] || B }
                                            if (p) {
                                                B = a.p.idPrefix + B;
                                                if (f.repeatitems) {
                                                    if (f.cell) p =
                                                        b.jgrid.getAccessor(p, f.cell);
                                                    G || (G = J(O + S + K))
                                                }
                                                for (w = 0; w < G.length; w++) { u = b.jgrid.getAccessor(p, G[w]);
                                                    P[a.p.colModel[w + O + S + K].name] = u }
                            ...
                            pa = function() {
                                function e(v) {
                                    ...
                                    if (v.groups !== undefined) {
                                        (U = v.groups.length && v.groupOp.toString().toUpperCase() === "OR") && r.orBegin();
                                        for (H = 0; H < v.groups.length; H++) { B > 0 && U && r.or();
                                            try { e(v.groups[H]) } catch (ha) { alert(ha) }
                                            B++ }
                                        U && r.orEnd() }
                                    if (v.rules !== undefined) {
                                        ...
                                        try {
                                            (ia = v.rules.length && v.groupOp.toString().toUpperCase() === "OR") && r.orBegin();
                                            for (H = 0; H < v.rules.length; H++) { W = v.rules[H];
                                                $ = v.groupOp.toString().toUpperCase();
                                                if (w[W.op] && W.field) {
                                                    if (B > 0 && $ && $ === "OR") r = r.or();
                                                    r = w[W.op](r, $)(W.field, W.data, m[W.field]) }
                                                B++ }
                                            ia && r.orEnd() } catch (ja) { alert(ja) }
                                    }
                                }
                                var f, j = false,
                                    m = {},
                                ...
                                if (b.isArray(a.p.data)) {
                                    ...
                                    b.each(a.p.colModel, function() {
                                        ...
                                        if (A == "date" || A == "datetime") {
                                            if (this.formatter &&
                                                typeof this.formatter === "string" && this.formatter == "date") { s = this.formatoptions && this.formatoptions.srcformat ? this.formatoptions.srcformat : b.jgrid.formatter.date.srcformat;
                                                z = this.formatoptions && this.formatoptions.newformat ? this.formatoptions.newformat : b.jgrid.formatter.date.newformat } else s = z = this.datefmt || "Y-m-d";
                                            m[this.name] = { stype: A, srcfmt: s, newfmt: z }
                                        } else m[this.name] = { stype: A, srcfmt: "", newfmt: "" };
                                        if (a.p.grouping && this.name == u.groupField[0]) {
                                            var v = this.name;
                                            if (typeof this.index != "undefined") v =
                                                this.index;
                                            p[0] = m[v];
                                            C.push(v)
                                        }
                                        if (!j && (this.index == a.p.sortname || this.name == a.p.sortname)) { f = this.name;
                                            j = true }
                                    });
                                    if (a.p.treeGrid) b(a).jqGrid("SortTree", f, a.p.sortorder, m[f].stype, m[f].srcfmt);
                                        ...
                                        if (a.p.search ===
                                            ...
                                            if (G) {
                                                ...
                                                e(G) } else try { r = w[a.p.postData.searchOper](r)(a.p.postData.searchField, a.p.postData.searchString, m[a.p.postData.searchField]) } catch (O) {} }
                                        if (a.p.grouping) { r.orderBy(C, u.groupOrder[0], p[0].stype, p[0].srcfmt);
                            ...
                            R = function() { a.grid.hDiv.loading = true;
                            ...
                            ka = function(e) {
                                if (!a.grid.hDiv.loading) {
                                    ...
                                    e = e || 1;
                                    if (e > 1)
                                        if (p.npage !== null) { j[p.npage] = e;
                                            A = e - 1;
                                            e = 1 } else C = function(u) { a.p.page++;
                                    ...
                                    if (a.p.grouping) {
                                        ...
                                        if (a.p.groupingView.groupDataSorted === true) j[p.sort] = a.p.groupingView.groupField[0] + " " + a.p.groupingView.groupOrder[0] +
                                            ", " + j[p.sort]
                                    }
                                    ...
                                    if (b.isFunction(a.p.datatype)) a.p.datatype.call(a, a.p.postData, "load_" + a.p.id);
                                        ...
                                        if (b.isFunction(a.p.beforeRequest)) { j = a.p.beforeRequest.call(a);
                                        ...
                                        switch (m) {
                                            ...
                                            case "script":
                                                b.ajax(b.extend({
                                                    ...
                                                    success: function(u, w, r) { b.isFunction(a.p.beforeProcessing) && a.p.beforeProcessing.call(a, u, w, r);
                                                        ...
                                                        e === 1 && aa() },
                                                    error: function(u, w, r) { b.isFunction(a.p.loadError) && a.p.loadError.call(a, u, w, r);
                                                        e === 1 && aa() },
                            ...
                            sa = function(e) { b("#cb_" + b.jgrid.jqID(a.p.id), a.grid.hDiv)[a.p.useProp ? "prop" : "attr"]("checked", e);
                        ...
                        x = function(e, f) {
                            ...
                            A = e + "_center";
                            z = e + "_right";
                            b("#" + b.jgrid.jqID(e)).append("<div id='" + C + "' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='" + s + "' align='left'></td><td id='" + A + "' align='center' style='white-space:pre;'></td><td id='" +
                                z + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr");
                            if (a.p.rowList.length > 0) { p = "<td dir='" + l + "'>";
                                ...
                                p += "</select></td>" }
                            if (l == "rtl") m += p;
                            if (a.p.pginput === true) j = "<td dir='" + l + "'>" + b.jgrid.format(a.p.pgtext || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>",
                                "<span id='sp_1_" + b.jgrid.jqID(e) + "'></span>") + "</td>";
                            ...
                            a.p._nvtd[1] = 0;
                            m = null;
                            b(".ui-pg-selbox", "#" + C).bind("change", function() {
                            ...
                            if (a.p.pgbuttons === true) {
                                b(".ui-pg-button", "#" + C).hover(function() {
                                    if (b(this).hasClass("ui-state-disabled")) this.style.cursor = "default";
                                        ...
                                        this.style.cursor = "pointer" } }, function() {
                                    if (!b(this).hasClass("ui-state-disabled")) { b(this).removeClass("ui-state-hover");
                                ...
                                b("#first" + b.jgrid.jqID(f) + ", #prev" + b.jgrid.jqID(f) + ", #next" + b.jgrid.jqID(f) + ", #last" + b.jgrid.jqID(f)).click(function() {
                                    ...
                                    if (r === 0 || r === 1) L = K = S = O = false;
                                        ...
                                        if (w === 1) S = O = false;
                                            ...
                                            if (w === r) L = K = false }
                                    else if (r > 1 && w === 0) { L = K = false;
                                        w = r - 1 }
                                    if (this.id === "first" + f && O) { a.p.page = 1;
                                        G = true }
                                    if (this.id === "prev" + f && S) { a.p.page = w - 1;
                                        G = true }
                                    if (this.id === "next" + f && K) { a.p.page = w + 1;
                                        G = true }
                                    if (this.id === "last" + f && L) {
                                        a.p.page = r;
                                        G =
                            ...
                            a.p.pginput === true && b("input.ui-pg-input", "#" + C).keypress(function(w) {
                                if ((w.charCode ? w.charCode : w.keyCode ? w.keyCode : 0) == 13) { a.p.page = b(this).val() > 0 ? b(this).val() : a.p.page;
                        ...
                        var Ea = function(e, f, j, m) {
                                    ...
                                    if (!(a.p.savedRow.length > 0)) {
                                        if (!j) {
                                            if (a.p.lastsort == f)
                                                ...
                                                a.p.colModel[f].firstsortorder || "asc";
                                            a.p.page = 1
                                        }
                                        if (m)
                                            if (a.p.lastsort == f && a.p.sortorder == m && !j) return;
                                        ...
                                        if (a.p.datatype == "local") a.p.deselectAfterSort && b(a).jqGrid("resetSelection");
                                            ...
                                            a.p.selarrrow = [];
                                            a.p.savedRow = [] }
                                        if (a.p.scroll) { j = a.grid.bDiv.scrollLeft;
                                            D(a.grid.bDiv, true, false);
                                            a.grid.hDiv.scrollLeft = j }
                                        a.p.subGrid && a.p.datatype == "local" && b("td.sgexpanded", "#" + b.jgrid.jqID(a.p.id)).each(function() { b(this).trigger("click") });
                                        ka();
                                        a.p.lastsort = f;
                            ...
                            Ia = function(e) {
                                ...
                                for (f = j[0] = j[1] = j[2] = 0; f <= e; f++)
                                    if (a.p.colModel[f].hidden === false) j[0] += a.p.colModel[f].width + m;
                                ...
                                if (a.p.toolbar[0] === true && (a.p.toolbar[1] == "top" || a.p.toolbar[1] ==
                                        "both")) j[1] += b(a.grid.uDiv).height() + parseInt(b(a.grid.uDiv).css("border-top-width"), 10) + parseInt(b(a.grid.uDiv).css("border-bottom-width"), 10);
                        ...
                        a.p.keyIndex = false;
                        for (k = 0; k < a.p.colModel.length; k++) { a.p.colModel[k] = b.extend(true, {}, a.p.cmTemplate, a.p.colModel[k].template || {}, a.p.colModel[k]);
                        ...
                        if (this.p.treeGrid === true) {
                            try { b(this).jqGrid("setTreeGrid") } catch (Ma) {}
                            if (a.p.datatype != "local") a.p.localReader = { id: "_id_" }
                        }
                        if (this.p.subGrid) try { b(a).jqGrid("setSubGrid") } catch (Na) {}
                        if (this.p.multiselect) { this.p.colNames.unshift("<input role='checkbox' id='cb_" + this.p.id + "' class='cbox' type='checkbox'/>");
                        ...
                        if (a.p.viewsortcols[1] == "horizontal") { oa = " ui-i-asc";
                            na = " ui-i-desc" }
                        ...
                        oa = null;
                        b(this).append(da);
                        b("thead tr:first th", this).hover(function() { b(this).addClass("ui-state-hover") }, function() { b(this).removeClass("ui-state-hover") });
                            ...
                            b("#cb_" + b.jgrid.jqID(a.p.id), this).bind("click", function() {
                                ...
                                if (this.checked) {
                                    b(a.rows).each(function(f) {
                                        if (f > 0)
                                            if (!b(this).hasClass("ui-subgrid") && !b(this).hasClass("jqgroup") && !b(this).hasClass("ui-state-disabled")) {
                                                b("#jqg_" + b.jgrid.jqID(a.p.id) +
                                                    "_" + b.jgrid.jqID(this.id))[a.p.useProp ? "prop" : "attr"]("checked", true);
                                                b(this).addClass("ui-state-highlight").attr("aria-selected", "true");
                                                a.p.selarrrow.push(this.id);
                                                a.p.selrow = this.id;
                                                if (e) { b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + b.jgrid.jqID(this.id), a.grid.fbDiv)[a.p.useProp ? "prop" : "attr"]("checked", true);
                                    ...
                                    b(a.rows).each(function(f) {
                                        if (f > 0)
                                            if (!b(this).hasClass("ui-subgrid") && !b(this).hasClass("ui-state-disabled")) {
                                                b("#jqg_" +
                                                    b.jgrid.jqID(a.p.id) + "_" + b.jgrid.jqID(this.id))[a.p.useProp ? "prop" : "attr"]("checked", false);
                                                b(this).removeClass("ui-state-highlight").attr("aria-selected", "false");
                                                Aa.push(this.id);
                                                if (e) { b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + b.jgrid.jqID(this.id), a.grid.fbDiv)[a.p.useProp ? "prop" : "attr"]("checked", false);
                        ...
                        if (a.p.autowidth ===
                            true) { da = b(I).innerWidth();
                            a.p.width = da > 0 ? da : "nw" }(function() {
                            var e = 0,
                                f = E ? 0 : a.p.cellLayout,
                                j = 0,
                                m, p = a.p.scrollOffset,
                                C, s = false,
                                A, z = 0,
                                u = 0,
                                w;
                            ...
                            if (a.p.shrinkToFit === true && j > 0) {
                                A =
                                    h.width - f * j - z;
                                if (!isNaN(a.p.height)) { A -= p;
                                    s = true }
                                e = 0;
                                b.each(a.p.colModel, function(r) {
                                    if (this.hidden === false && !this.fixed) { this.width = C = Math.round(A * this.width / (a.p.tblwidth - f * j - z));
                                        e += C;
                                        m = r } });
                                w = 0;
                                if (s) {
                                    if (h.width - z - (e + f * j) !== p) w = h.width - z - (e + f * j) - p } else if (!s && Math.abs(h.width - z - (e + f * j)) !== 1) w = h.width - z - (e + f * j);
                                a.p.colModel[m].width += w;
                                a.p.tblwidth = e + w + f * j + z;
                                if (a.p.tblwidth > a.p.width) { a.p.colModel[m].width -= a.p.tblwidth - parseInt(a.p.width, 10);
                                    a.p.tblwidth = a.p.width }
                            }
                        })();
                        b(I).css("width", h.width +
                            "px").append("<div class='ui-jqgrid-resize-mark' id='rs_m" + a.p.id + "'>&#160;</div>");
                        ...
                        b("th", q).each(function(e) {
                            ...
                            if (ua)
                                if (a.p.viewsortcols[0]) { b("div span.s-ico", this).show();
                                    e == a.p.lastsort && b("div span.ui-icon-" + a.p.sortorder, this).removeClass("ui-state-disabled") } else if (e == a.p.lastsort) {
                            ...
                            if (b(e.target).closest("th>span.ui-jqgrid-resize").length == 1) {
                                ...
                                if (a.p.forceFit === true) {
                                    ...
                                    for (p = f + 1; p < a.p.colModel.length; p++)
                                        if (a.p.colModel[p].hidden !== true) { m = p;
                                            break }
                                    j.nv = m - f }
                            ...
                            if (e.length == 1) { f = Fa(this);
                                if (!a.p.viewsortcols[2]) { j = true;
                                    m = e.attr("sort") }
                                Ea(b("div", this)[0].id, f, j, m);
                                return false }
                        });
                        if (a.p.sortable && b.fn.sortable) try { b(a).jqGrid("sortableColumns", q) } catch (Oa) {}
                        if (a.p.footerrow) wa += "</tr></tbody></table>";
                        xa += "</tr>";
                        this.appendChild(document.createElement("tbody"));
                        b(this).addClass("ui-jqgrid-btable").append(xa);
                        xa = null;
                        q = b("<table class='ui-jqgrid-htable' style='width:" + a.p.tblwidth + "px' role='grid' aria-labelledby='gbox_" +
                            this.id + "' cellspacing='0' cellpadding='0' border='0'></table>").append(da);
                        ...
                        b(h.hDiv).css({ width: h.width + "px" }).addClass("ui-state-default ui-jqgrid-hdiv").append(k);
                        b(k).append(q);
                        q = null;
                        ea && b(h.hDiv).hide();
                        if (a.p.pager) {
                            if (typeof a.p.pager == "string") {
                                if (a.p.pager.substr(0, 1) != "#") a.p.pager = "#" + a.p.pager } else a.p.pager = "#" + b(a.p.pager).attr("id");
                            b(a.p.pager).css({ width: h.width + "px" }).appendTo(I).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom");
                            ea && b(a.p.pager).hide();
                            x(a.p.pager, "")
                        }
                        a.p.cellEdit === false && a.p.hoverrows === true && b(a).bind("mouseover", function(e) { Q = b(e.target).closest("tr.jqgrow");
                            b(Q).attr("class") !== "ui-subgrid" && b(Q).addClass("ui-state-hover") }).bind("mouseout", function(e) { Q = b(e.target).closest("tr.jqgrow");
                        ...
                        b(a).before(h.hDiv).click(function(e) {
                            ...
                            if (j === true) {
                                if (a.p.cellEdit === true)
                                    if (a.p.multiselect && f) b(a).jqGrid("setSelection", Q[0].id, true);
                                    else {
                                        la = Q[0].rowIndex;
                                        ma = b.jgrid.getCellIndex(Y);
                                        try { b(a).jqGrid("editCell", la, ma, true) } catch (m) {}
                                    }
                                else if (a.p.multikey)
                                    if (e[a.p.multikey]) b(a).jqGrid("setSelection", Q[0].id, true);
                                    else {
                                        if (a.p.multiselect && f) { f = b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + Q[0].id).is(":checked");
                                    ...
                                    if (a.p.multiselect && a.p.multiboxonly)
                                        if (!f) {
                                            ...
                                            b(a.p.selarrrow).each(function(C, s) {
                                                ...
                                                if (p) { b("#" + b.jgrid.jqID(s), "#" + b.jgrid.jqID(p)).removeClass("ui-state-highlight");
                                ...
                                if (b.isFunction(a.p.onCellSelect)) { la = Q[0].id;
                                    ma = b.jgrid.getCellIndex(Y);
                            ...
                            function(e, f) {
                                ...
                                if (a.p.datatype == "local") { b(a).jqGrid("resetSelection");
                                    a.p.data.length && ca() } else if (!a.p.treeGrid) { a.p.selrow = null;
                                    if (a.p.multiselect) { a.p.selarrrow = [];
                                        sa(false) }
                                    a.p.savedRow = [] }
                                ...
                                if (a.grid.prevRowHeight &&
                                    ...
                                    a.grid.populateVisible() } else a.grid.populate();
                                return false
                            });
                        b.isFunction(this.p.ondblClickRow) && b(this).dblclick(function(e) { Y = e.target;
                            Q = b(Y, a.rows).closest("tr.jqgrow");
                        ...
                        if (y)
                            if (String(a.p.height).toLowerCase() === "auto") a.p.height = "100%";
                        ...
                        if (y) { b("tbody", this).size() == 2 && b("tbody:gt(0)", this).remove();
                            a.p.multikey && b(h.bDiv).bind("selectstart", function() {
                                return false }) } else a.p.multikey && b(h.bDiv).bind("mousedown", function() {
                            return false });
                        ea && b(h.bDiv).hide();
                        h.cDiv = document.createElement("div");
                        var Ba = a.p.hidegrid === true ? b("<a role='link' href='javascript:void(0)'/>").addClass("ui-jqgrid-titlebar-close HeaderButton").hover(function() { Ba.addClass("ui-state-hover") },
                            function() { Ba.removeClass("ui-state-hover") }).append("<span class='ui-icon ui-icon-circle-triangle-n'></span>").css(l == "rtl" ? "left" : "right", "0px") : "";
                        ...
                        if (a.p.toolbar[0]) {
                            ...
                            if (a.p.toolbar[1] == "top") b(h.uDiv).insertBefore(h.hDiv);
                                ...
                                "bottom" && b(h.uDiv).insertAfter(h.hDiv);
                            if (a.p.toolbar[1] == "both") { h.ubDiv = document.createElement("div");
                                ...
                                ea && b(h.ubDiv).hide() } else b(h.uDiv).width(h.width).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id);
                            ea && b(h.uDiv).hide()
                        }
                        if (a.p.toppager) {
                            a.p.toppager = b.jgrid.jqID(a.p.id) + "_toppager";
                            h.topDiv =
                                b("<div id='" + a.p.toppager + "'></div>")[0];
                        ...
                        if (a.p.caption) {
                            ...
                            if (a.p.hidegrid === true) {
                                b(".ui-jqgrid-titlebar-close", h.cDiv).click(function(e) {
                                    ...
                                    if (a.p.gridstate == "visible") b(j, "#gbox_" + b.jgrid.jqID(a.p.id)).slideUp("fast", function() {
                                        m--;
                                        if (m === 0) { b("span", p).removeClass("ui-icon-circle-triangle-n").addClass("ui-icon-circle-triangle-s");
                                    ...
                                    else a.p.gridstate == "hidden" && b(j, "#gbox_" + b.jgrid.jqID(a.p.id)).slideDown("fast", function() {
                                        m--;
                                        if (m === 0) {
                        ...
                        b(h.hDiv).after(h.bDiv).mousemove(function(e) {
                            if (h.resizing) { h.dragMove(e);
                                return false } });
                        b(".ui-jqgrid-labels", h.hDiv).bind("selectstart", function() {
                            return false });
                        b(document).mouseup(function() {
                            if (h.resizing) { h.dragEnd();
                                return false }
                            return true });
                        a.formatCol = N;
                        a.sortData = Ea;
                        a.updatepager = function(e, f) {
                            ...
                            if (a.p.scroll) {
                                ...
                                if (m = j.outerHeight() || a.grid.prevRowHeight) {
                                    j = p * m;
                                    m *= parseInt(a.p.records,
                                        10);
                                    b(">div:first", a.grid.bDiv).css({ height: m }).children("div:first").css({ height: j, display: j ? "" : "none" })
                                }
                            ...
                            if (u) {
                                ...
                                if (a.p.pginput === true) {
                                    ...
                                    b(C).html(b.fmatter ? b.fmatter.util.NumberFormat(a.p.lastpage,
                                        z) : a.p.lastpage)
                                }
                                if (a.p.viewrecords)
                                    if (a.p.reccount === 0) b(".ui-paging-info", u).html(a.p.emptyrecords);
                                    else { C = p + 1;
                                        A = a.p.records;
                                        if (b.fmatter) { C = b.fmatter.util.NumberFormat(C, z);
                                ...
                                if (a.p.pgbuttons === true) {
                                    if (j <= 0) j = m = 0;
                                    if (j == 1 || j === 0) { b("#first" + w + ", #prev" + w).addClass("ui-state-disabled").removeClass("ui-state-hover");
                                        a.p.toppager && b("#first_t" + r + ", #prev_t" + r).addClass("ui-state-disabled").removeClass("ui-state-hover") } else {
                                        b("#first" +
                                            w + ", #prev" + w).removeClass("ui-state-disabled");
                                        a.p.toppager && b("#first_t" + r + ", #prev_t" + r).removeClass("ui-state-disabled")
                                    }
                                    if (j == m || j === 0) { b("#next" + w + ", #last" + w).addClass("ui-state-disabled").removeClass("ui-state-hover");
                                        a.p.toppager && b("#next_t" + r + ", #last_t" + r).addClass("ui-state-disabled").removeClass("ui-state-hover") } else { b("#next" + w + ", #last" + w).removeClass("ui-state-disabled");
                                        a.p.toppager && b("#next_t" + r + ", #last_t" + r).removeClass("ui-state-disabled") }
                                }
                            }
                            e === true && a.p.rownumbers === true &&
                                b("td.jqgrid-rownum", a.rows).each(function(G) { b(this).html(p + 1 + G) });
                        ...
                        a.formatter = function(e, f, j, m, p) {
                            return o(e, f, j, m, p) };
                        b.extend(h, { populate: ka, emptyRows: D });
                        this.grid = h;
                        a.addXmlData = function(e) { X(e, a.grid.bDiv) };
                        a.addJSONData = function(e) { fa(e, a.grid.bDiv) };
    ...
    b.jgrid.extend({
        ...
        setGridParam: function(d) {
            return this.each(function() { this.grid && typeof d === "object" && b.extend(true, this.p, d) }) },
        getDataIDs: function() {
            var d = [],
                i = 0,
                g, c = 0;
            this.each(function() {
                if ((g = this.rows.length) && g > 0)
                    for (; i < g;) {
                        if (b(this.rows[i]).hasClass("jqgrow")) { d[c] = this.rows[i].id;
                            c++ }
                        i++ } });
            return d },
            ...
            return this.each(function() {
                function g(x) {
                    ...
                    if (I + x >= y + E) b(c.grid.bDiv)[0].scrollTop = I - (y + E) + x + E;
                        ...
                        if (I < E) b(c.grid.bDiv)[0].scrollTop = I
                }
                var c = this,
                    h, k, l, a, q;
                if (d !== undefined) {
                    ...
                    if (!(!k || !k.className || k.className.indexOf("ui-state-disabled") > -1)) {
                        if (c.p.scrollrows === true) { h = c.rows.namedItem(d).rowIndex;
                            h >= 0 && g(h) }
                        ...
                        if (c.p.multiselect) {
                            ...
                            if (l === -1) { k.className !== "ui-subgrid" && b(k).addClass("ui-state-highlight").attr("aria-selected", "true");
                                h = true;
                                b("#jqg_" + b.jgrid.jqID(c.p.id) + "_" + b.jgrid.jqID(c.p.selrow))[c.p.useProp ? "prop" : "attr"]("checked", h);
                                c.p.selarrrow.push(c.p.selrow) } else {
                                k.className !== "ui-subgrid" && b(k).removeClass("ui-state-highlight").attr("aria-selected", "false");
                                h = false;
                                b("#jqg_" + b.jgrid.jqID(c.p.id) + "_" + b.jgrid.jqID(c.p.selrow))[c.p.useProp ? "prop" : "attr"]("checked",
                                    h);
                                c.p.selarrrow.splice(l, 1);
                                a = c.p.selarrrow[0];
                                c.p.selrow = a === undefined ? null : a
                            }
                            if (q) { l === -1 ? b("#" + b.jgrid.jqID(d), "#" + b.jgrid.jqID(q)).addClass("ui-state-highlight") : b("#" + b.jgrid.jqID(d), "#" + b.jgrid.jqID(q)).removeClass("ui-state-highlight");
                            ...
                            if (c.p.selrow != k.id) {
                                ...
                                if (q) { b("#" + b.jgrid.jqID(c.p.selrow), "#" + b.jgrid.jqID(q)).removeClass("ui-state-highlight");
        ...
        resetSelection: function(d) {
            return this.each(function() {
                ...
                if (typeof d !== "undefined") {
                    ...
                    b("#" + b.jgrid.jqID(i.p.id) +
                        " tbody:first tr#" + b.jgrid.jqID(c)).removeClass("ui-state-highlight").attr("aria-selected", "false");
                    if (i.p.multiselect) { b("#jqg_" + b.jgrid.jqID(i.p.id) + "_" + b.jgrid.jqID(c))[i.p.useProp ? "prop" : "attr"]("checked", false);
                        i.setHeadCheckBox(false) }
                    c = null
                } else if (i.p.multiselect) {
                    b(i.p.selarrrow).each(function(h, k) { g = i.rows.namedItem(k);
                    ...
                    i.setHeadCheckBox(false);
                    i.p.selarrrow = []
                } else if (i.p.selrow) { b("#" + b.jgrid.jqID(i.p.id) + " tbody:first tr#" + b.jgrid.jqID(i.p.selrow)).removeClass("ui-state-highlight").attr("aria-selected", "false");
                    i.p.selrow = null }
                if (i.p.cellEdit === true)
                    if (parseInt(i.p.iCol, 10) >= 0 && parseInt(i.p.iRow, 10) >= 0) { b("td:eq(" + i.p.iCol + ")", i.rows[i.p.iRow]).removeClass("edit-cell ui-state-highlight");
        ...
        getRowData: function(d) {
            ...
            this.each(function() {
                var l =
                    this,
                    a, q;
                if (typeof d == "undefined") { c = true;
                    g = [];
                    h = l.rows.length } else { q = l.rows.namedItem(d);
                    if (!q) return i;
                    h = 2 }
                for (; k < h;) {
                    if (c) q = l.rows[k];
                    if (b(q).hasClass("jqgrow")) { b("td", q).each(function(x) { a = l.p.colModel[x].name;
                            if (a !== "cb" && a !== "subgrid" && a !== "rn")
                                if (l.p.treeGrid === true && a == l.p.ExpandColumn) i[a] = b.jgrid.htmlDecode(b("span:first", this).html());
                                else try { i[a] = b.unformat(this, { rowId: q.id, colModel: l.p.colModel[x] }, x) } catch (y) { i[a] = b.jgrid.htmlDecode(b(this).html()) } });
                        if (c) { g.push(i);
                            i = {} } }
                    k++ }
            });
        ...
        delRowData: function(d) {
            var i = false,
                g, c;
            this.each(function() {
                if (g = this.rows.namedItem(d)) { b(g).remove();
                    this.p.records--;
                    this.p.reccount--;
                    this.updatepager(true, false);
                    i = true;
                    if (this.p.multiselect) { c = b.inArray(d, this.p.selarrrow);
                        c != -1 && this.p.selarrrow.splice(c, 1) }
                    if (d == this.p.selrow) this.p.selrow = null } else return false;
                if (this.p.datatype == "local") {
                    var h = this.p._index[d];
                    if (typeof h != "undefined") { this.p.data.splice(h, 1);
                        this.refreshIndex() } }
                if (this.p.altRows === true && i) {
                    var k = this.p.altclass;
                    b(this.rows).each(function(l) { l % 2 == 1 ? b(this).addClass(k) : b(this).removeClass(k) })
                }
            });
            return i
        },
            ...
            this.each(function() {
                ...
                if (i) try {
                    ...
                    if (l.p.datatype == "local") {
                        var E = l.p._index[d];
                        if (l.p.treeGrid)
                            for (var I in l.p.treeReader) y.hasOwnProperty(l.p.treeReader[I]) && delete y[l.p.treeReader[I]];
            ...
            if (i) {
                ...
                this.each(function() {
                    ...
                    if (!N)
                        ...
                        else { d = b.jgrid.randId();
                            if (this.p.keyIndex !== false) { V = this.p.colModel[this.p.keyIndex + a + q + x].name;
                    ...
                    for (var T = 0, J = "", D = {},
                        ...
                        l = "";
                        if (N) {
                            try { d = n[V] } catch (X) { d = b.jgrid.randId() }
                            J = this.p.altRows === true ? (this.rows.length - 1) % 2 === 0 ? o : "" : "" }
                        d = this.p.idPrefix + d;
                        if (x) { M = this.formatCol(0, 1, "", null, d, true);
                        ...
                        if (a) {
                            ...
                            l += '<td role="gridcell" aria-describedby="' +
                                this.p.id + '_cb" ' + M + ">" + I + "</td>"
                        }
                        if (q) l += b(this).jqGrid("addSubGridCell", a + x, 1);
                        for (E = a + q + x; E < this.p.colModel.length; E++) { t = this.p.colModel[E];
                            k = t.name;
                        ...
                        l = '<tr id="' + d + '" role="row" tabindex="-1" class="ui-widget-content jqgrow ui-row-' +
                            this.p.direction + " " + J + '">' + l + "</tr>";
                        if (this.rows.length === 0) b("table:first", this.grid.bDiv).append(l);
                            ...
                            case "after":
                                ...
                                break;
                            case "before":
                                if (y = this.rows.namedItem(c)) { b(y).before(l);
                                    y = y.rowIndex }
                                y-- }
                        this.p.subGrid === true && b(this).jqGrid("addSubGrid",
                            a + x, y);
                        this.p.records++;
                        this.p.reccount++;
                        ca && this.p.afterInsertRow.call(this, d, n, n);
                        T++;
                        if (this.p.datatype == "local") { D[this.p.localReader.id] = d;
                            this.p._index[d] = this.p.data.length;
                            this.p.data.push(D);
                            D = {} }
                    }
                    if (this.p.altRows === true && !N)
                        if (g == "last")(this.rows.length - 1) % 2 == 1 && b(this.rows[this.rows.length - 1]).addClass(o);
                        else b(this.rows).each(function(fa) { fa % 2 == 1 ? b(this).addClass(o) : b(this).removeClass(o) });
        ...
        footerData: function(d, i, g) {
            function c(q) {
                for (var x in q)
                    if (q.hasOwnProperty(x)) return false;
                return true
            }
            var h, k = false,
                l = {},
            ...
            this.each(function() {
                ...
                b(this.p.colModel).each(function(y) {
                    h = this.name;
                    if (d == "set") {
                        if (i[h] !== undefined) { x = g ? q.formatter("", i[h], y, i, "edit") : i[h];
                            a = this.title ? { title: b.jgrid.stripHtml(x) } : {};
                            b("tr.footrow td:eq(" + y + ")", q.grid.sDiv).html(x).attr(a);
                            k = true } } else if (d == "get") l[h] = b("tr.footrow td:eq(" +
                        y + ")", q.grid.sDiv).html()
                })
            });
            return d == "get" ? l : k
                ...
                if (g.grid) {
                    ...
                    b(this.p.colModel).each(function(q) {
                        if (b.inArray(this.name, d) !== -1 && this.hidden === l) {
                            if (g.p.frozenColumns ===
                                true && this.frozen === true) return true;
                            b("tr", g.grid.hDiv).each(function() { b(this.cells[q]).css("display", i) });
                            b(g.rows).each(function() { b(this.cells[q]).css("display", i) });
        ...
        hideCol: function(d) {
            return this.each(function() { b(this).jqGrid("showHideCol", d, "none") }) },
        showCol: function(d) {
            return this.each(function() { b(this).jqGrid("showHideCol", d, "") }) },
        remapColumns: function(d, i, g) {
            function c(l) {
                var a;
                a = l.length ? b.makeArray(l) : b.extend({}, l);
                b.each(d, function(q) { l[q] = a[this] }) }

            function h(l, a) { b(">tr" + (a || ""), l).each(function() {
                    var q = this,
            ...
            if (k.p.remapColumns)
                if (k.p.remapColumns.length) c(k.p.remapColumns);
            ...
            return this.each(function() {
                if (this.grid) {
                    var g = this,
                        c, h = 0,
                        k = b.browser.webkit ||
                        b.browser.safari ? 0 : g.p.cellLayout,
                        l, a = 0,
                        q = false,
                        x = g.p.scrollOffset,
                        y, E = 0,
                    ...
                    if (!isNaN(d)) {
                        ...
                        if (i === true) {
                            b.each(g.p.colModel, function() {
                                if (this.hidden === false) { c = this.widthOrg ? this.widthOrg : parseInt(this.width, 10);
                                    h += c + k;
                                    if (this.fixed) E += c + k;
                                    else a++;
                                    I++ } });
                            ...
                            y = d - k * a - E;
                            if (!isNaN(g.p.height))
                                if (b(g.grid.bDiv)[0].clientHeight < b(g.grid.bDiv)[0].scrollHeight || g.rows.length === 1) { q = true;
                                    y -= x }
                            h = 0;
                            var N =
                                g.grid.cols.length > 0;
                            b.each(g.p.colModel, function(V) {
                                if (this.hidden === false && !this.fixed) { c = this.widthOrg ? this.widthOrg : parseInt(this.width, 10);
                            ...
                            M = 0;
                            if (q) {
                                if (d - E - (h + k * a) !== x) M = d - E - (h + k * a) - x } else if (Math.abs(d - E - (h + k * a)) !== 1) M = d - E - (h + k * a);
                            g.p.colModel[l].width +=
                                M;
                            g.p.tblwidth = h + M + k * a + E;
                            if (g.p.tblwidth > d) { q = g.p.tblwidth - parseInt(d, 10);
                                g.p.tblwidth = d;
                                c = g.p.colModel[l].width -= q } else c = g.p.colModel[l].width;
                        ...
                        if (g.p.tblwidth) {
                            ...
                            g.p.footerrow &&
                                b("table:first", g.grid.sDiv).css("width", g.p.tblwidth + "px")
                        }
                    }
                }
            })
        ...
        setCaption: function(d) {
            return this.each(function() { this.p.caption = d;
        ...
        setLabel: function(d, i, g, c) {
            return this.each(function() {
                var h = -1;
                if (this.grid)
                    if (typeof d != "undefined") { b(this.p.colModel).each(function(a) {
                            if (this.name == d) { h = a;
                                return false } });
                        if (h >= 0) {
                        ...
                        if (a = this.rows.namedItem(d)) {
                            ...
                            if (g !== "" || k === true) {
                                ...
                                if (this.p.datatype == "local") {
                                    ...
                                    q = this.p._index[d];
                                    if (typeof q != "undefined") this.p.data[q][a.name] =
                                        g
                                }
                            }
            ...
            this.each(function() {
                ...
                if (this.grid) {
                    ...
                    if (c >= 0) {
                        ...
                        if (h) try { g = b.unformat(b("td:eq(" + c + ")", h), { rowId: h.id, colModel: this.p.colModel[c] }, c) } catch (k) { g = b.jgrid.htmlDecode(b("td:eq(" + c + ")", h).html()) } } } });
            return g },
        getCol: function(d,
            i, g) {
            var c = [],
                        ...
                        if (y && y > 0) {
                            for (; E < y;) {
                                if (b(this.rows[E]).hasClass("jqgrow")) {
                                    try { h = b.unformat(b(this.rows[E].cells[x]), { rowId: this.rows[E].id, colModel: this.p.colModel[x] }, x) } catch (I) { h = b.jgrid.htmlDecode(this.rows[E].cells[x].innerHTML) }
                                    if (g) {
                                        q =
                                            parseFloat(h);
                                        k += q;
                                        if (E === 0) a = l = q;
                                            ...
                                            a = Math.max(a, q) }
                                    } else i ? c.push({ id: this.rows[E].id, value: h }) : c.push(h)
                                }
                                E++
                            }
        ...
        bindKeys: function(d) {
            var i =
                b.extend({ onEnter: null, onSpace: null, onLeftKey: null, onRightKey: null, scrollingRows: true }, d || {});
            return this.each(function() {
                var g = this;
                ...
                b(g).keydown(function(c) {
                    var h = b(g).find("tr[tabindex=0]")[0],
                        k, l, a, q = g.p.treeReader.expanded_field;
                    if (h) {
                        a = g.p._index[h.id];
                            ...
                            if (c.keyCode === 38) {
                                ...
                                if (l)
                                    if (b(l).is(":hidden"))
                                        for (; l;) {
                                            l = l.previousSibling;
                                            if (!b(l).is(":hidden") && b(l).hasClass("jqgrow")) { k = l.id;
                                                break }
                                        } else k = l.id;
                                b(g).jqGrid("setSelection", k)
                            }
                            if (c.keyCode === 40) { l = h.nextSibling;
                                k = "";
                                if (l)
                                    if (b(l).is(":hidden"))
                                        for (; l;) { l = l.nextSibling;
                                            if (!b(l).is(":hidden") && b(l).hasClass("jqgrow")) { k = l.id;
                                                break } } else k = l.id;
                                b(g).jqGrid("setSelection", k) }
                            if (c.keyCode === 37) { g.p.treeGrid && g.p.data[a][q] && b(h).find("div.treeclick").trigger("click");
                                b.isFunction(i.onLeftKey) && i.onLeftKey.call(g, g.p.selrow) }
                            if (c.keyCode === 39) {
                                g.p.treeGrid && !g.p.data[a][q] &&
        ...
        unbindKeys: function() {
            return this.each(function() { b(this).unbind("keydown") }) },
        getLocalRow: function(d) {
            var i = false,
                g;
            this.each(function() {
                if (typeof d !== "undefined") { g = this.p._index[d];
...
(function(b) {
    ...
    b.fmatter.util = {
        NumberFormat: function(a, c) {
            ...
            if (b.fmatter.isNumber(a)) {
                ...
                if (b.fmatter.isNumber(c.decimalPlaces)) {
                    ...
                    if (h > 0) {
                        if (e < 0) { f += g;
                            e = f.length - 1 } else if (g !== ".") f = f.replace(".", g);
                        for (; f.length - 1 - e < h;) f += "0" }
                }
                if (c.thousandsSeparator) { h = c.thousandsSeparator;
                    e = f.lastIndexOf(g);
                    e = e > -1 ? e : f.length;
                    g = f.substring(e);
                    for (var i = -1, j = e; j > 0; j--) { i++;
        ...
        DateFormat: function(a, c, d, f) {
            ...
            g = function(m, r) { m = String(m);
                for (r = parseInt(r, 10) || 2; m.length < r;) m = "0" + m;
                return m };
            var h = { m: 1, d: 1, y: 1970, h: 0, i: 0, s: 0, u: 0 },
                i = 0,
                j, k = ["i18n"];
            ...
            if (!isNaN(c - 0) && String(a).toLowerCase() == "u") i = new Date(parseFloat(c) * 1E3);
                ...
                if (e[3]) {
                    ...
                    i.setTime(Number(Number(i) +
                        a * 6E4))
                }
            } else { c = String(c).split(/[\\\/:_;.,\t\T\s-]/);
                a = a.split(/[\\\/:_;.,\t\T\s-]/);
                e = 0;
                for (j = a.length; e < j; e++) {
                    if (a[e] == "M") { i = b.inArray(c[e], k.i18n.monthNames);
                        if (i !== -1 && i < 12) c[e] = i + 1 }
                    if (a[e] == "F") { i = b.inArray(c[e], k.i18n.monthNames);
    ...
    b.fn.fmatter.link = function(a, c) {
        ...
        return b.fmatter.isEmpty(a) ? b.fn.fmatter.defaultFormat(a, c) : "<a " + f + ' href="' +
            a + '">' + a + "</a>"
    };
    b.fn.fmatter.showlink = function(a, c) {
        var d = { baseLinkUrl: c.baseLinkUrl, showAction: c.showAction, addParam: c.addParam || "", target: c.target, idName: c.idName },
            f = "";
        b.fmatter.isUndefined(c.colModel.formatoptions) || (d = b.extend({}, d, c.colModel.formatoptions));
        if (d.target) f = "target=" + d.target;
    ...
    b.fn.fmatter.date = function(a, c, d, f) {
        d = b.extend({}, c.date);
        b.fmatter.isUndefined(c.colModel.formatoptions) || (d = b.extend({}, d, c.colModel.formatoptions));
        return !d.reformatAfterEdit && f == "edit" ? b.fn.fmatter.defaultFormat(a, c) : b.fmatter.isEmpty(a) ? b.fn.fmatter.defaultFormat(a, c) : b.fmatter.util.DateFormat(d.srcformat,
            a, d.newformat, d)
    };
    b.fn.fmatter.select = function(a, c) {
        ...
        if (b.fmatter.isUndefined(c.colModel.formatoptions)) {
            if (!b.fmatter.isUndefined(c.colModel.editoptions)) { d = c.colModel.editoptions.value;
                g = c.colModel.editoptions.separator === undefined ? ":" : c.colModel.editoptions.separator } } else { d = c.colModel.formatoptions.value;
        ...
        if (d) {
            ...
            if (b.fmatter.isString(d))
                for (var j = d.split(";"), k = 0, l = 0; l < j.length; l++) { i = j[l].split(g);
                    if (i.length > 2) i[1] = jQuery.map(i, function(n, o) {
                        if (o > 0) return n }).join(":");
                    if (e) {
                        if (jQuery.inArray(i[0], h) > -1) { f[k] = i[1];
                            k++ } } else if (b.trim(i[0]) == b.trim(a)) { f[0] = i[1];
                        break } } else if (b.fmatter.isObject(d))
                    if (e) f = jQuery.map(h, function(n) {
                        return d[n] });
                    else f[0] = d[a] || ""
        }
        a = f.join(", ");
    ...
    b.fn.fmatter.rowactions = function(a, c, d,
        f) {
        var g = { keys: false, onEdit: null, onSuccess: null, afterSave: null, onError: null, afterRestore: null, extraparam: {}, url: null, delOptions: {}, editOptions: {} };
        a = b.jgrid.jqID(a);
        c = b.jgrid.jqID(c);
        ...
        var h = function(j) { g.afterRestore && g.afterRestore.call(e, j);
            b("tr#" + a + " div.ui-inline-edit, tr#" + a + " div.ui-inline-del", "#" + c + ".ui-jqgrid-btable:first").show();
            b("tr#" + a + " div.ui-inline-save, tr#" + a + " div.ui-inline-cancel", "#" + c + ".ui-jqgrid-btable:first").hide() };
        if (b("#" + a,
        ...
        switch (d) {
            case "edit":
                ...
                break;
            case "save":
                if (b("#" + c).jqGrid("saveRow", a, g.onSuccess,
                        g.url, g.extraparam, f, g.onError, h)) { b("tr#" + a + " div.ui-inline-edit, tr#" + a + " div.ui-inline-del", "#" + c + ".ui-jqgrid-btable:first").show();
                    b("tr#" + a + " div.ui-inline-save, tr#" + a + " div.ui-inline-cancel", "#" + c + ".ui-jqgrid-btable:first").hide();
                    b.isFunction(e.p._complete) && e.p._complete.call(e) }
                break;
            case "cancel":
    ...
    b.fn.fmatter.actions = function(a, c) {
        var d = { keys: false, editbutton: true, delbutton: true, editformbutton: false };
        b.fmatter.isUndefined(c.colModel.formatoptions) || (d = b.extend(d, c.colModel.formatoptions));
        var f = c.rowId,
            g = "",
            e;
        if (typeof f == "undefined" ||
            b.fmatter.isEmpty(f)) return "";
        if (d.editformbutton) { e = "onclick=jQuery.fn.fmatter.rowactions('" + f + "','" + c.gid + "','formedit'," + c.pos + "); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ";
            g = g + "<div title='" + b.jgrid.nav.edittitle + "' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' " + e + "><span class='ui-icon ui-icon-pencil'></span></div>" } else if (d.editbutton) {
            e = "onclick=jQuery.fn.fmatter.rowactions('" + f + "','" + c.gid + "','edit'," +
                c.pos + "); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover') ";
        ...
        if (d.delbutton) {
            ...
            g = g + "<div title='" +
                b.jgrid.nav.deltitle + "' style='float:left;margin-left:5px;' class='ui-pg-div ui-inline-del' " + e + "><span class='ui-icon ui-icon-trash'></span></div>"
        }
    ...
    b.unformat = function(a, c, d, f) {
        ...
        return g !== undefined ?
            g : f === true ? b(a).text() : b.jgrid.htmlDecode(b(a).html())
    };
        ...
        if (c.value) {
            ...
            if (b.fmatter.isString(g))
                for (var h = g.split(";"), i = 0, j = 0; j < h.length; j++) {
                    e = h[j].split(":");
                    if (e.length > 2) e[1] = jQuery.map(e, function(k, l) {
                        if (l > 0) return k }).join(":");
                    if (c) {
                    ...
                    } else if (b.trim(e[1]) == b.trim(a)) { d[0] = e[0];
                        break }
                } else if (b.fmatter.isObject(g) || b.isArray(g)) { c || (f[0] = a);
    ...
    b.unformat.date = function(a, c) {
        ...
        return b.fmatter.isEmpty(a) ? b.fn.fmatter.defaultFormat(a, c) : b.fmatter.util.DateFormat(d.newformat,
            a, d.srcformat, d)
    }
})(jQuery);
(function(a) {
    a.jgrid.extend({
                ...
                if (this.grid)
                    if (e)
                        for (var c = this.p.colModel, j = 0; j < c.length; j++)
                            if (c[j].name == b) { a.extend(this.p.colModel[j], e);
                                break } }) },
                ...
                if (this.grid) {
                    ...
                    for (var k = 0; k < this.p.colModel.length; k++)
                        if (this.p.colModel[k].index ==
                            b || this.p.colModel[k].name == b) { j = k;
                            break }
                    if (j != -1) { k = this.p.colModel[j].sortable;
        ...
        GridDestroy: function() {
            return this.each(function() {
                if (this.grid) { this.p.pager && a(this.p.pager).remove();
                    var b = this.id;
                    try { a("#gbox_" + b).remove() } catch (e) {} } }) },
        GridUnload: function() {
            return this.each(function() {
                if (this.grid) {
                    ...
                    if (a(this.p.pager).parents("#gbox_" + b).length === 1) { a(e).insertBefore("#gbox_" + b).show();
                        a(this.p.pager).insertBefore("#gbox_" + b) } else a(e).insertBefore("#gbox_" + b).show();
                    a("#gbox_" + b).remove()
                }
            })
        },
            ...
            return this.each(function() {
                if (this.grid)
                    if (b == "hidden") {
                        ...
                        if (this.p.toolbar[0] === true) { this.p.toolbar[1] == "both" && a(this.grid.ubDiv).slideUp("fast");
                    ...
                    if (this.p.toolbar[0] === true) { this.p.toolbar[1] == "both" && a(this.grid.ubDiv).slideDown("fast");
        ...
        filterToolbar: function(b) {
            ...
            return this.each(function() {
                function e(d, g) {
                    var h = a(d);
                    h[0] && jQuery.each(g, function() { this.data !== undefined ? h.bind(this.type, this.data, this.fn) : h.bind(this.type, this.fn) }) }
                var c = this;
                if (!this.ftoolbar) {
                    var j = function() {
                            var d = {},
                            ...
                            a.each(c.p.colModel, function() {
                                ...
                                m = this.searchoptions && this.searchoptions.sopt ?
                                    this.searchoptions.sopt[0] : this.stype == "select" ? "eq" : b.defaultSearch;
                                if (h = a("#gs_" + a.jgrid.jqID(this.name), this.frozen === true && c.p.frozenColumns === true ? c.grid.fhDiv : c.grid.hDiv).val()) { d[f] = h;
                                    i[f] = m;
                                    g++ } else try { delete c.p.postData[f] } catch (r) {}
                            });
                            ...
                            if (b.stringResult === true || c.p.datatype == "local") {
                                ...
                                a.each(["searchField", "searchString", "searchOper"], function(r, v) { c.p.postData.hasOwnProperty(v) && delete c.p.postData[v] })
                            } else a.extend(c.p.postData, d);
                            var o;
                            if (c.p.searchurl) { o = c.p.url;
                                a(c).jqGrid("setGridParam", { url: c.p.searchurl }) }
                            var q = false;
                            if (a.isFunction(b.beforeSearch)) q = b.beforeSearch.call(c);
                            q || a(c).jqGrid("setGridParam", { search: n }).trigger("reloadGrid", [{ page: 1 }]);
                    ...
                    a.each(c.p.colModel, function() {
                        ...
                        if (this.search) switch (this.stype) {
                            case "select":
                                if (i =
                                    this.surl || f.dataUrl) a.ajax(a.extend({
                                    url: i,
                                    dataType: "html",
                                    success: function(o) {
                                        ...
                                        a("select", g).attr({ name: d.index || d.name, id: "gs_" + d.name });
                                        f.attr && a("select", g).attr(f.attr);
                                        a("select", g).css({ width: "100%" });
                                    ...
                                    if (m) {
                                        ...
                                        i.style.width = "100%";
                                        a(i).attr({ name: d.index || d.name, id: "gs_" + d.name });
                                        var n, l;
                                        if (typeof m === "string") { m = m.split(";");
                                            for (var t = 0; t < m.length; t++) { n = m[t].split(":");
                                                l = document.createElement("option");
                                                l.value = n[0];
                                                l.innerHTML = n[1];
                                                i.appendChild(l) } } else if (typeof m ===
                                            "object")
                                            for (n in m)
                                                if (m.hasOwnProperty(n)) { l = document.createElement("option");
                                                    l.value = n;
                                                    l.innerHTML = m[n];
                                                    i.appendChild(l) }
                                        ...
                                        a(g).append(i);
                                        b.autosearch === true && a(i).change(function() { j();
                                            return false })
                                    }
                                }
                                break;
                            case "text":
                                ...
                                a(g).append("<input type='text' style='width:95%;padding:0px;' name='" + (d.index || d.name) + "' id='gs_" +
                                    d.name + "' value='" + i + "'/>");
                                ...
                                if (b.autosearch === true) b.searchOnEnter ? a("input", g).keypress(function(o) {
                                    if ((o.charCode ? o.charCode : o.keyCode ? o.keyCode : 0) == 13) { j();
                                        return false }
                                    return this }) : a("input", g).keydown(function(o) {
                                    switch (o.which) {
                                        case 13:
                                            return false;
                                        case 9:
                    ...
                    this.clearToolbar = function(d) {
                            ...
                            switch (this.stype) {
                                case "select":
                                    ...
                                    a("#gs_" + a.jgrid.jqID(this.name) + " option", this.frozen === true && c.p.frozenColumns === true ? c.grid.fhDiv : c.grid.hDiv).each(function(s) {
                                        if (s ===
                                            0) this.selected = true;
                                        if (a(this).text() == h) { this.selected = true;
                                            q = a(this).val();
                                            return false }
                                    });
                                    if (q) { g[i] = q;
                                        f++ } else try { delete c.p.postData[i] } catch (r) {}
                                    break;
                                case "text":
                                    a("#gs_" + a.jgrid.jqID(this.name), this.frozen === true && c.p.frozenColumns === true ? c.grid.fhDiv : c.grid.hDiv).val(h);
                                    if (h) { g[i] = h;
                                        f++ } else try { delete c.p.postData[i] } catch (v) {}
                            }
                        });
                        ...
                        if (b.stringResult === true || c.p.datatype == "local") {
                            ...
                            n += "]}";
                            a.extend(c.p.postData, { filters: n });
                            a.each(["searchField", "searchString", "searchOper"], function(q, r) { c.p.postData.hasOwnProperty(r) && delete c.p.postData[r] })
                        } else a.extend(c.p.postData, g);
                        var t;
                        if (c.p.searchurl) { t = c.p.url;
                            a(c).jqGrid("setGridParam", { url: c.p.searchurl }) }
                        var o = false;
                        if (a.isFunction(b.beforeClear)) o = b.beforeClear.call(c);
                        o || d && a(c).jqGrid("setGridParam", { search: m }).trigger("reloadGrid", [{ page: 1 }]);
                        t && a(c).jqGrid("setGridParam", { url: t });
        ...
        destroyGroupHeader: function(b) {
            ...
            return this.each(function() {
                ...
                var g = a("table.ui-jqgrid-htable thead", c.hDiv),
                    h = this.p.colModel;
                if (c) { e = a("<tr>", { role: "rowheader" }).addClass("ui-jqgrid-labels");
                    k = c.headers;
                    c = 0;
                    for (j = k.length; c < j; c++) { p = h[c].hidden ? "none" : "";
                        p = a(k[c].el).width(k[c].width).css("display", p);
                        try { p.removeAttr("rowSpan") } catch (f) { p.attr("rowSpan", 1) }
                        e.append(p);
                    ...
                    a(g).prepend(e);
                    b === true && a(this).jqGrid("setGridParam", { groupHeader: null }) }
            })
        },
        setGroupHeaders: function(b) {
            b =
                a.extend({ useColSpanStyle: false, groupHeaders: [] }, b || {});
            return this.each(function() {
                ...
                if (q.html() === null) q = a("<tr>", { role: "row", "aria-hidden": "true" }).addClass("jqg-first-row-header").css("height", "auto");
                else q.empty();
                var r, v = function(s, u) {
                    for (var w = 0, x = u.length; w < x; w++)
                        if (u[w].startColumnName === s) return w;
                    return -1 };
                a(e).prepend(p);
                p = a("<tr>", { role: "rowheader" }).addClass("ui-jqgrid-labels jqg-third-row-header");
                for (c = 0; c < m; c++) {
                    g = n[c].el;
                    h = a(g);
                    j = i[c];
                    d = { height: "0px", width: n[c].width + "px", display: j.hidden ? "none" : "" };
                    a("<th>", { role: "gridcell" }).css(d).addClass("ui-first-th-" + e.p.direction).appendTo(q);
                    g.style.width = "";
                    ...
                    if (d >= 0) {
                        ...
                        f = d.titleText;
                        for (d =
                            j = 0; d < k && c + d < m; d++) i[c + d].hidden || j++;
                        d = a("<th>").attr({ role: "columnheader" }).addClass("ui-state-default ui-th-column-header ui-th-" + e.p.direction).css({ height: "22px", "border-top": "0px none" }).html(f);
                        ...
                        if (b.useColSpanStyle) h.attr("rowspan", "2");
                        else {
                            a("<th>", { role: "columnheader" }).addClass("ui-state-default ui-th-column-header ui-th-" + e.p.direction).css({
                                display: j.hidden ?
                                    "none" : "",
                                "border-top": "0px none"
                            }).insertBefore(h);
                ...
                if (b.useColSpanStyle) {
                    ...
                    l.find("div.ui-jqgrid-sortable").each(function() {
                        var s = a(this),
                            u = s.parent();
                        u.is(":visible") && u.is(":has(span.ui-jqgrid-resize)") && s.css("top", (u.height() -
                            s.outerHeight()) / 2 + "px")
                    })
                }
                if (a.isFunction(e.p.resizeStop)) o = e.p.resizeStop;
                r = i.find("tr.jqg-first-row-header");
                e.p.resizeStop = function(s, u) { r.find("th").eq(u).width(s);
                    ...
                    if (!(b.p.subGrid == true || b.p.treeGrid === true || b.p.cellEdit == true || b.p.sortable || b.p.scroll || b.p.grouping)) {
                        ...
                        if (k >= 0 && p) {
                            ...
                            if (b.p.toolbar[0] == true)
                                if (b.p.toolbar[1] != "bottom") e += a(b.grid.uDiv).outerHeight();
                            ...
                            b.grid.fbDiv = a('<div style="position:absolute;left:0px;top:' +
                                (parseInt(e, 10) + parseInt(c, 10) + 1) + 'px;overflow-y:hidden" class="frozen-bdiv ui-jqgrid-bdiv"></div>');
                            a("#gview_" + a.jgrid.jqID(b.p.id)).append(b.grid.fhDiv);
                            e = a(".ui-jqgrid-htable", "#gview_" + a.jgrid.jqID(b.p.id)).clone(true);
                            if (b.p.groupHeader) {
                                a("tr.jqg-first-row-header, tr.jqg-third-row-header", e).each(function() { a("th:gt(" + k + ")", this).remove() });
                                var d = -1,
                                    g = -1;
                                ...
                                if (d !==
                                    k) g = k;
                                a("tr.jqg-second-row-header", e).each(function() { a("th:gt(" + g + ")", this).remove() })
                            } else a("tr", e).each(function() { a("th:gt(" + k + ")", this).remove() });
                            a(e).width(1);
                            a(b.grid.fhDiv).append(e).mousemove(function(h) {
                                if (b.grid.resizing) { b.grid.dragMove(h);
                                    return false } });
                            ...
                            b.p.onSortCol = function(h, f, i) {
                                ...
                                if (!b.p.viewsortcols[0])
                                    if (b.p.lastsort != f) { a("span.s-ico", m).hide();
                                        a("span.s-ico", n).show() }
                            ...
                            jQuery(b.grid.bDiv).scroll(function() { jQuery(b.grid.fbDiv).scrollTop(jQuery(this).scrollTop()) });
                            ...
                            b.p._complete = function() {
                                ...
                                a("tr", h).each(function() { a("td:gt(" + k + ")", this).remove() });
                                a(h).width(1).attr("id", a.jgrid.jqID(b.p.id) + "_frozen");
                                a(b.grid.fbDiv).append(h);
                                if (b.p.hoverrows === true) {
                                    a("tr.jqgrow", h).hover(function() { a(this).addClass("ui-state-hover");
                                        a("#" + a.jgrid.jqID(this.id), "#" + a.jgrid.jqID(b.p.id)).addClass("ui-state-hover") }, function() {
                                        a(this).removeClass("ui-state-hover");
                                        a("#" + a.jgrid.jqID(this.id), "#" + a.jgrid.jqID(b.p.id)).removeClass("ui-state-hover")
                                    });
                                    a("tr.jqgrow", "#" + a.jgrid.jqID(b.p.id)).hover(function() { a(this).addClass("ui-state-hover");
                                        a("#" + a.jgrid.jqID(this.id), "#" + a.jgrid.jqID(b.p.id) + "_frozen").addClass("ui-state-hover") }, function() { a(this).removeClass("ui-state-hover");
                    ...
                    if (this.p.frozenColumns === true) {
                        ...
                        if (this.p.hoverrows == true) {
                            ...
                            a("#" + a.jgrid.jqID(this.p.id)).bind("mouseover", function(e) {
                                ...
                                a(b).attr("class") !==
                                    "ui-subgrid" && a(b).addClass("ui-state-hover")
                            }).bind("mouseout", function(e) { b = a(e.target).closest("tr.jqgrow");
    ...
    b.jgrid.extend({
        setSubGrid: function() {
            return this.each(function() {
                ...
                if (f[0]) { f[0].align = b.extend([], f[0].align || []);
        ...
        addSubGridCell: function(f, d) {
            var a = "",
                n, s;
            this.each(function() { a = this.formatCol(f, d);
                s = this.p.id;
        ...
        addSubGrid: function(f, d) {
            return this.each(function() {
                var a =
                    this;
                if (a.grid) {
                    var n = function(g, j, e) { j = b("<td align='" + a.p.subGridModel[0].align[e] + "'></td>").html(j);
                            b(g).append(j) },
                        s = function(g, j) {
                            var e, c, h, k = b("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
                                i = b("<tr></tr>");
                            for (c = 0; c < a.p.subGridModel[0].name.length; c++) { e = b("<th class='ui-state-default ui-th-subgrid ui-th-column ui-th-" + a.p.direction + "'></th>");
                            ...
                            if (g) {
                                ...
                                b(h.root + " " + h.row, g).each(function() { i = b("<tr class='ui-widget-content ui-subtblcell'></tr>");
                                    if (h.repeatitems === true) b(h.cell, this).each(function(m) { n(i, b(this).text() || "&#160;", m) });
                                    else {
                                        var o = a.p.subGridModel[0].mapping || a.p.subGridModel[0].name;
                                        if (o)
                                            for (c = 0; c < o.length; c++) n(i, b(o[c], this).text() || "&#160;", c) }
                                    b(k).append(i) })
                            }
                        ...
                        v = function(g, j) {
                            var e,
                                c, h, k, i, o = b("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
                                m = b("<tr></tr>");
                            for (c = 0; c < a.p.subGridModel[0].name.length; c++) { e = b("<th class='ui-state-default ui-th-subgrid ui-th-column ui-th-" + a.p.direction + "'></th>");
                                b(e).html(a.p.subGridModel[0].name[c]);
                                b(e).width(a.p.subGridModel[0].width[c]);
                                ...
                                if (typeof e !== "undefined")
                                    for (c = 0; c < e.length; c++) {
                                        ...
                                        if (k.repeatitems === true) {
                                            ...
                                            for (i = 0; i < h.length; i++) n(m, h[i] || "&#160;", i) } else {
                                            var u = a.p.subGridModel[0].mapping || a.p.subGridModel[0].name;
                                            if (u.length)
                                                for (i = 0; i < u.length; i++) n(m, h[u[i]] || "&#160;", i) }
                                        b(o).append(m)
                                    }
                            }
                            ...
                            if (a.p.subGridModel[0].params)
                                for (h = 0; h < a.p.subGridModel[0].params.length; h++)
                                    for (c = 0; c < a.p.colModel.length; c++)
                                        if (a.p.colModel[c].name == a.p.subGridModel[0].params[h]) e[a.p.colModel[c].name] = b("td:eq(" + c + ")", g).text().replace(/\&#160\;/ig, "");
                            if (!a.grid.hDiv.loading) {
                                ...
                                switch (a.p.subgridtype) {
                                    ...
                                    case "json":
                                        b.ajax(b.extend({
                                            ...
                                            complete: function(k) { a.p.subgridtype == "xml" ? s(k.responseXML, j) : v(b.jgrid.parse(k.responseText), j) }
                    ...
                    for (; r < y;) {
                            ...
                            function() {
                                ...
                                if (b(this).hasClass("sgcollapsed")) {
                                    ...
                                    if (a.p.subGridOptions.reloadOnExpand === true || a.p.subGridOptions.reloadOnExpand === false && !b(q).hasClass("ui-subgrid")) {
                                        ...
                                        b(g).after("<tr role='row' class='ui-subgrid'>" + w + "<td class='ui-widget-content subgrid-cell'><span class='ui-icon " +
                                            a.p.subGridOptions.openicon + "'></span></td><td colspan='" + parseInt(a.p.colNames.length - 1 - x, 10) + "' class='ui-widget-content subgrid-data'><div id=" + t + "_" + l + " class='tablediv'></div></td></tr>");
                                    ...
                                    a.p.subGridOptions.selectOnExpand && b(a).jqGrid("setSelection",
                                        l)
                                } else if (b(this).hasClass("sgexpanded")) { p = true;
                                    if (b.isFunction(a.p.subGridRowColapsed)) { l = g.id;
                        ...
                        a.p.subGridOptions.expandOnLoad === true &&
                            b(a.rows[r].cells[f]).trigger("click");
                        r++
                    }
                    a.subGridXml = function(g, j) { s(g, j) };
                    a.subGridJson = function(g, j) { v(g, j) }
                }
            })
        },
    ...
    e.jgrid.extend({
        groupingSetup: function() {
            return this.each(function() {
                ...
                if (a !== null && (typeof a === "object" || e.isFunction(a)))
                    if (a.groupField.length) {
                        ...
                        for (var c = 0; c < a.groupField.length; c++) {
                            ...
                            if (typeof a.groupSummary[c] != "boolean") a.groupSummary[c] =
                                false;
                            if (a.groupColumnShow[c] === true) { a.visibiltyOnNextGrouping[c] = true;
                                e(this).jqGrid("showCol", a.groupField[c]) } else { a.visibiltyOnNextGrouping[c] = e("#" + this.p.id + "_" + a.groupField[c]).is(":visible");
                                e(this).jqGrid("hideCol", a.groupField[c]) }
                            a.sortitems[c] = [];
                            a.sortnames[c] = [];
                            a.summaryval[c] = [];
                            if (a.groupSummary[c]) { a.summary[c] = [];
                                for (var b = this.p.colModel, d = 0, g = b.length; d < g; d++) b[d].summaryType && a.summary[c].push({ nm: b[d].name, st: b[d].summaryType, v: "" }) }
                        }
                        this.p.scroll = false;
        ...
        groupingRender: function(a, c) {
            return this.each(function() {
                ...
                if (!d.groupDataSorted) {
                    d.sortitems[0].sort();
                    d.sortnames[0].sort();
                    if (d.groupOrder[0].toLowerCase() == "desc") { d.sortitems[0].reverse();
                        d.sortnames[0].reverse() }
                }
                k += " tree-wrap-" + b.p.direction;
                for (m = 0; m < c;) {
                    if (b.p.colModel[m].name == d.groupField[0]) { r = m;
                        break }
                    m++ }
                e.each(d.sortitems[0], function(o, n) {
                    ...
                    try { l = b.formatter(f, d.sortnames[0][o], r, d.sortitems[0]) } catch (v) { l = d.sortnames[0][o] }
                    g +=
                        '<tr id="' + f + '" role="row" class= "ui-widget-content jqgroup ui-row-' + b.p.direction + '"><td colspan="' + c + '">' + h + e.jgrid.format(d.groupText[0], l, a[n].length) + "</td></tr>";
                        ...
                        for (var p = b.p.colModel, q, s = a[n].length, j = 0; j < c; j++) {
                            ...
                            e.each(i, function() {
                                if (this.nm == p[j].name) {
                                    ...
                                    if (this.st == "avg")
                                        if (this.v && s > 0) this.v /= s;
                                    try { q = b.formatter("", this.v, j, this) } catch (w) { q = this.v }
        ...
        groupingGroupBy: function(a, c) {
            return this.each(function() {
                ...
                if (typeof b.visibiltyOnNextGrouping ==
        ...
        groupingRemove: function(a) {
            return this.each(function() {
                ...
                if (a === true) {
                    for (var c =
                            this.p.groupingView, b = 0; b < c.groupField.length; b++) !c.groupColumnShow[b] && c.visibiltyOnNextGrouping[b] && e(this).jqGrid("showCol", c.groupField);
                    ...
                    for (var e = b.p.expColInd, g = b.p.treeReader.expanded_field, h = b.p.treeReader.leaf_field, f = b.p.treeReader.level_field, l = b.p.treeReader.icon_field, i = b.p.treeReader.loaded, j, o, n, k; a < c;) {
                        ...
                        if (b.p.treeGridModel == "nested")
                            if (!k[h]) {
                                ...
                                b.rows[a].cells[b.p._treeleafpos].innerHTML =
                                    k[h]
                            }
                        j = parseInt(k[f], 10);
                        if (b.p.tree_root_level === 0) { n = j + 1;
                            o = j } else { n = j;
                            o = j - 1 }
                        ...
                        if (k[h] == "true" || k[h] === true) { n += (k[l] !== undefined && k[l] !== "" ? k[l] : b.p.treeIcons.leaf) + " tree-leaf treeclick";
                            k[h] = true;
                            o = "leaf" } else { k[h] = false;
                            o = "" }
                        k[g] = (k[g] == "true" || k[g] === true ? true : false) &&
                            k[i];
                        ...
                        d(b.rows[a].cells[e]).find("div.treeclick").bind("click", function(m) {
                            m = d(m.target || m.srcElement, b.rows).closest("tr.jqgrow")[0].id;
                            m = b.p._index[m];
                            if (!b.p.data[m][h])
                                if (b.p.data[m][g]) { d(b).jqGrid("collapseRow", b.p.data[m]);
                                    d(b).jqGrid("collapseNode", b.p.data[m]) } else { d(b).jqGrid("expandRow", b.p.data[m]);
                        ...
                        b.p.ExpandColClick === true && d(b.rows[a].cells[e]).find("span.cell-wrapper").css("cursor", "pointer").bind("click", function(m) {
                            ...
                            if (!b.p.data[r][h])
                                ...
                                } else { d(b).jqGrid("expandRow", b.p.data[r]);
        ...
        setTreeGrid: function() {
            return this.each(function() {
                ...
                if (a.p.treeGrid) {
                    ...
                    a.p.expColInd =
                        0;
                    a.p.treeIcons = d.extend({ plus: "ui-icon-triangle-1-" + (a.p.direction == "rtl" ? "w" : "e"), minus: "ui-icon-triangle-1-s", leaf: "ui-icon-radio-off" }, a.p.treeIcons || {});
                    if (a.p.treeGridModel == "nested") a.p.treeReader = d.extend({ level_field: "level", left_field: "lft", right_field: "rgt", leaf_field: "isLeaf", expanded_field: "expanded", loaded: "loaded", icon_field: "icon" }, a.p.treeReader);
                    ...
                    for (g in a.p.colModel)
                        if (a.p.colModel.hasOwnProperty(g)) { e = a.p.colModel[g].name;
                            if (e == a.p.ExpandColumn && !b) { b = true;
                                a.p.expColInd = c }
                            c++;
                    ...
                    d.each(a.p.treeReader, function(l, i) {
                        if (i && d.inArray(i, h) === -1) {
                            ...
                            c++;
                            a.p.colNames.push(i);
                            a.p.colModel.push({ name: i, width: 1, hidden: true, sortable: false, resizable: false, hidedlg: true, editable: true, search: false }) } })
                }
            })
        },
            ...
            this.each(function() {
                ...
                if (c.grid && c.p.treeGrid) switch (c.p.treeGridModel) {
                    case "nested":
                        ...
                        d(c.p.data).each(function() { parseInt(this[b], 10) === parseInt(c.p.tree_root_level, 10) && a.push(this) });
                        break;
                    case "adjacency":
                ...
                if (this.grid && this.p.treeGrid) switch (this.p.treeGridModel) {
                    case "nested":
                        ...
                        d(this.p.data).each(function() {
                            if (parseInt(this[g], 10) === l - 1 && parseInt(this[b], 10) < h && parseInt(this[e], 10) > f) { c = this;
                                return false } });
                        break;
                    case "adjacency":
                ...
                if (this.grid && this.p.treeGrid) switch (this.p.treeGridModel) {
                    case "nested":
                        var b = this.p.treeReader.left_field,
                            ...
                            f = parseInt(a[e], 10),
                            l = parseInt(a[g], 10);
                        d(this.p.data).each(function() { parseInt(this[g], 10) === l + 1 && parseInt(this[b], 10) > h && parseInt(this[e], 10) < f && c.push(this) });
                        break;
                    case "adjacency":
                        var i = this.p.treeReader.parent_id_field,
                            j = this.p.localReader.id;
                        d(this.p.data).each(function() { this[i] == a[j] && c.push(this) })
                }
            });
            return c
        },
        getFullTreeNode: function(a) {
            ...
            this.each(function() {
                ...
                if (this.grid && this.p.treeGrid) switch (this.p.treeGridModel) {
                    case "nested":
                        var e =
                            this.p.treeReader.left_field,
                            g = this.p.treeReader.right_field,
                            h = this.p.treeReader.level_field,
                            f = parseInt(a[e], 10),
                            l = parseInt(a[g], 10),
                            i = parseInt(a[h], 10);
                        d(this.p.data).each(function() { parseInt(this[h], 10) >= i && parseInt(this[e], 10) >= f && parseInt(this[e], 10) <= l && c.push(this) });
                        break;
                    case "adjacency":
                        if (a) { c.push(a);
                            var j = this.p.treeReader.parent_id_field,
                                o = this.p.localReader.id;
                            d(this.p.data).each(function(n) { b = c.length;
                                for (n = 0; n < b; n++)
                                    if (c[n][o] == this[j]) { c.push(this);
                                        break } }) }
                }
            });
            return c
        ...
        getNodeAncestors: function(a) {
            ...
            this.each(function() {
                if (this.grid && this.p.treeGrid)
                    for (var b = d(this).jqGrid("getNodeParent", a); b;) { c.push(b);
                ...
                if (this.grid && this.p.treeGrid) {
                    ...
                    if (!a[c]) {
                        var l = d.jgrid.getAccessor(a, this.p.localReader.id),
                            ...
                            j = this.p._index[l];
                        if (d(this).jqGrid("isNodeLoaded", this.p.data[j])) { a[c] = true;
                            d("div.treeclick", i).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus") } else {
                            a[c] = true;
                            ...
                            this.p.treeGridModel == "nested" ? d(this).jqGrid("setGridParam", { postData: { nodeid: l, n_left: a[h], n_right: a[f], n_level: a[g] } }) : d(this).jqGrid("setGridParam", { postData: { nodeid: l, parentid: a[b], n_level: a[g] } });
            ...
            return this.each(function() {
                ...
                if (this.grid && this.p.treeGrid) {
                    ...
                    if (l !== undefined) {
                        ...
                        if (l.length > 0)
                            for (var i = 0; i < l.length; i++) d(this).jqGrid("delRowData", l[i][c]);
                        if (this.p.treeGridModel === "nested") {
                            c = d.jgrid.from(this.p.data).greater(b, g, { stype: "integer" }).select();
                            if (c.length)
                                for (f in c) c[f][b] = parseInt(c[f][b],
                                    10) - h;
                            c = d.jgrid.from(this.p.data).greater(e, g, { stype: "integer" }).select();
                            if (c.length)
                                for (f in c) c[f][e] = parseInt(c[f][e], 10) - h
                        }
                    }
                }
            })
            ...
            if (b) {
                ...
                if (typeof a === "undefined" || a === null) {
                    ...
                    if (p >= 0)
                        for (; p >= 0;) {
                            n = Math.max(n,
                                parseInt(e.p.data[p][e.p.localReader.id], 10));
                            p--
                        }
                    a = n + 1
                }
                ...
                t = false;
                if (c === undefined || c === null || c === "") { s = c = null;
                    n = "last";
                    r = e.p.tree_root_level;
                    p = e.p.data.length + 1 } else {
                    n = "after";
                    k = e.p._index[c];
                    m = e.p.data[k];
                    ...
                    if (p.length) { s = p = p[p.length - 1][e.p.localReader.id];
                        p = d(e).jqGrid("getInd", s) + 1 } else p = d(e).jqGrid("getInd", c) + 1;
                    if (m[h]) {
                        t = true;
                        m[g] = true;
                ...
                if (e.p.treeGridModel === "nested") {
                    var q;
                    if (c !== null) { h = parseInt(m[j], 10);
                        f = d.jgrid.from(e.p.data);
                        f = f.greaterOrEquals(j, h, { stype: "integer" });
                        f = f.select();
                        if (f.length)
                            for (q in f) { f[q][i] = f[q][i] > h ? parseInt(f[q][i], 10) + 2 : f[q][i];
                        ...
                        if (f.length)
                            for (q in f) f[q][i] = parseInt(f[q][i], 10) + 2;
                        f = d.jgrid.from(e.p.data).greater(j, h, { stype: "integer" }).select();
                        if (f.length)
                            for (q in f) f[q][j] = parseInt(f[q][j], 10) + 2;
                        b[i] = h + 1;
                        b[j] = h + 2
                    }
                }
                if (c === null || d(e).jqGrid("isNodeLoaded", m) || t) { d(e).jqGrid("addRowData", a, b, n, s);
...
(function(a) {
            ...
            if (a.ui.multiselect.prototype._setSelected) {
                ...
                a.ui.multiselect.prototype._setSelected = function(b, h) {
                    ...
                    if (h && this.selectedList) {
                        var f = this.element;
                        this.selectedList.find("li").each(function() { a(this).data("optionLink") && a(this).data("optionLink").remove().appendTo(f) }) }
                    return c } }
            if (a.ui.multiselect.prototype.destroy) a.ui.multiselect.prototype.destroy =
                function() { this.element.show();
    ...
    a.jgrid.extend({
        sortableColumns: function(b) {
            return this.each(function() {
                function h() { c.p.disableClick = true }
                var c = this,
                    f = c.p.id;
                f = {
                    tolerance: "pointer",
                    ...
                    placeholder: {
                        element: function(g) {
                            return a(document.createElement(g[0].nodeName)).addClass(g[0].className +
                                " ui-sortable-placeholder ui-state-highlight").removeClass("ui-sortable-helper")[0]
                        },
                        update: function(g, j) { j.height(g.currentItem.innerHeight() - parseInt(g.currentItem.css("paddingTop") || 0, 10) - parseInt(g.currentItem.css("paddingBottom") || 0, 10));
                    ...
                    update: function(g, j) {
                        ...
                        setTimeout(function() { c.p.disableClick = false }, 50)
                    }
                };
                ...
                if (f.start) {
                    var e = f.start;
                    f.start = function(g, j) { h();
                        e.call(this, g, j) } } else f.start = h;
                if (c.p.sortable.exclude) f.items +=
                    ":not(" + c.p.sortable.exclude + ")";
        ...
        columnChooser: function(b) {
            function h(d, k) {
                if (d)
                    if (typeof d == "string") a.fn[d] && a.fn[d].apply(k, a.makeArray(arguments).slice(2));
            ...
            if (!a("#colchooser_" + c[0].p.id).length) {
                ...
                b = a.extend({
                    ...
                    height: 240,
                    classname: null,
                    done: function(d) { d && c.jqGrid("remapColumns", d, true) },
                    msel: "multiselect",
                    dlog: "dialog",
                    dlog_opts: function(d) {
                        var k = {};
                        k[d.bSubmit] = function() { d.apply_perm();
                            d.cleanup(false) };
                        k[d.bCancel] = function() { d.cleanup(true) };
                        return { buttons: k, close: function() { d.cleanup(true) }, modal: d.modal ? d.modal : false, resizable: d.resizable ? d.resizable : true, width: d.width + 20 } },
                    apply_perm: function() {
                        a("option", e).each(function() {
                            this.selected ? c.jqGrid("showCol", g[this.value].name) : c.jqGrid("hideCol",
                                g[this.value].name)
                        });
                        var d = [];
                        a("option:selected", e).each(function() { d.push(parseInt(this.value, 10)) });
                        a.each(d, function() { delete i[g[parseInt(this, 10)].name] });
                        a.each(i, function() {
                            ...
                            if (o >= 0) {
                                ...
                                n[o] = k;
                                d = n.concat(r) } else d = void 0 });
                        b.done && b.done.call(c, d)
                    },
                    cleanup: function(d) { h(b.dlog, f, "destroy");
                        h(b.msel, e, "destroy");
                        f.remove();
                ...
                if (a.ui)
                    if (a.ui.multiselect)
                        if (b.msel == "multiselect") {
                            if (!a.jgrid._multiselect) { alert("Multiselect plugin loaded after jqGrid. Please load the plugin before the jqGrid!");
                                return }
                            b.msel_opts = a.extend(a.ui.multiselect.defaults, b.msel_opts) }
                b.caption && f.attr("title", b.caption);
                if (b.classname) { f.addClass(b.classname);
                    e.addClass(b.classname) }
                if (b.width) { a(">div", f).css({ width: b.width, margin: "0 auto" });
                    e.css("width", b.width) }
                if (b.height) { a(">div", f).css("height", b.height);
                    e.css("height", b.height - 10) }
                var g =
                    c.jqGrid("getGridParam", "colModel"),
                    j = c.jqGrid("getGridParam", "colNames"),
                    i = {},
                    l = [];
                e.empty();
                a.each(g, function(d) { i[this.name] = d;
                    ...
                    if (!h.p.treeGrid)
                        if (a.fn.sortable) {
                            ...
                            if (b.start && a.isFunction(b.start)) { b._start_ = b.start;
                                delete b.start } else b._start_ = false;
                            if (b.update && a.isFunction(b.update)) { b._update_ = b.update;
                                delete b.update } else b._update_ = false;
                            b.start = function(c, f) {
                                a(f.item).css("border-width", "0px");
                                a("td", f.item).each(function(j) { this.style.width = h.grid.cols[j].style.width });
                                if (h.p.subGrid) {
                                    var e = a(f.item).attr("id");
                                    try { a(h).jqGrid("collapseSubGridRow", e) } catch (g) {} }
                                b._start_ && b._start_.apply(this, [c, f])
                            };
                            b.update = function(c, f) { a(f.item).css("border-width", "");
                                h.p.rownumbers === true && a("td.jqgrid-rownum", h.rows).each(function(e) { a(this).html(e + 1 + (parseInt(h.p.page, 10) - 1) * parseInt(h.p.rowNum, 10)) });
                                        ...
                                        return a.extend({
                                            start: function(g, j) {
                                                if (c.p.subGrid) {
                                                    ...
                                                    try { a(c).jqGrid("collapseSubGridRow", i) } catch (l) {} }
                                                for (i = 0; i < a.data(c, "dnd").connectWith.length; i++) a(a.data(c, "dnd").connectWith[i]).jqGrid("getGridParam",
                                                    "reccount") == "0" && a(a.data(c, "dnd").connectWith[i]).jqGrid("addRowData", "jqg_empty_row", {});
                                                j.helper.addClass("ui-state-highlight");
                                                a("td", j.helper).each(function(m) { this.style.width = c.grid.headers[m].width + "px" });
                                    ...
                                    drop: function(e) {
                                        return a.extend({
                                            accept: function(g) {
                                                ...
                                                if (g.length > 0 && a.data(g[0], "dnd") !== undefined) { g = a.data(g[0], "dnd").connectWith;
                                            ...
                                            drop: function(g, j) {
                                                if (a(j.draggable).hasClass("jqgrow")) {
                                                    ...
                                                    if (!e.dropbyname) {
                                                        ...
                                                        try {
                                                            for (var p in i) {
                                                                if (i.hasOwnProperty(p) && k[l]) { d = k[l].name;
                                                                    m[d] = i[p] }
                                                                l++ }
                                                            i = m } catch (o) {}
                                                    }
                                                    j.helper.dropped = true;
                                                    if (e.beforedrop && a.isFunction(e.beforedrop)) { d = e.beforedrop.call(this, g, j, i, a("#" + c.id), a(this));
                                                        if (typeof d != "undefined" && d !== null && typeof d == "object") i = d }
                                                    if (j.helper.dropped) {
                                                        var n;
                                                        if (e.autoid)
                                                            if (a.isFunction(e.autoid)) n = e.autoid.call(this, i);
                                                            else { n = Math.ceil(Math.random() * 1E3);
                                                                n = e.autoidprefix + n }
            ...
            return this.each(function() {
                ...
                if (h.grid && a.fn.resizable) {
                    ...
                    if (b.alsoResize) { b._alsoResize_ = b.alsoResize;
                        delete b.alsoResize } else b._alsoResize_ = false;
                    if (b.stop && a.isFunction(b.stop)) { b._stop_ = b.stop;
                        delete b.stop } else b._stop_ = false;
                    b.stop = function(c, f) {
                        a(h).jqGrid("setGridParam", { height: a("#gview_" + h.p.id + " .ui-jqgrid-bdiv").height() });
